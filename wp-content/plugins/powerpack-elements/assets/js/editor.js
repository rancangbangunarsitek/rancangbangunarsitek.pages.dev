(function (madxartwork, $, window) {
	...
	madxartwork.addControlView( 'pp-query', ControlQuery );
	...
	madxartwork.on( 'document:loaded', function() {
		madxartwork.channels.editor.on('ppWooBuilder:ApplyPreview', onApplyPreview );
	} );
	madxartwork.on( 'document:unload', function() {
		madxartwork.channels.editor.on('ppWooBuilder:ApplyPreview', onApplyPreview );
	} );
