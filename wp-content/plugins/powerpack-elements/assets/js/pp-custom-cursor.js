(function ($) {
	...
	var CustomCursorHandler = function ($scope, $) {
		...
		if ( 'yes' === custom_cursor_enable ) {
			...
			var selector  = ".madxartwork-element-" + columnId,
				$selector = $(".madxartwork-element-" + columnId);
    ...
    $(window).on('madxartwork/frontend/init', function () {
        ...
        madxartworkFrontend.hooks.addAction('frontend/element_ready/global', CustomCursorHandler);
    });
