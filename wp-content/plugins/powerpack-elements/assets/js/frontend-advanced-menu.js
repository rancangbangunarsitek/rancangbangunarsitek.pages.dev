;(function($) {
	...
	PPAdvancedMenu.prototype = {
		...
		bindEvents: function () {
			...
			if ('default' === this.menuType) {
				madxartworkFrontend.addListenerOnce( this.node.data( 'model-cid' ), 'resize', $.proxy( this.stretchMenu, this ) );
			}
		...
		panelUpdate: function() {
			...
			if ('undefined' !== typeof madxartwork && $( 'body' ).hasClass( 'madxartwork-editor-active' )) {
				madxartwork.hooks.addAction(
		...
		initStretchElement: function () {
			this.stretchElement = new madxartworkFrontend.modules.StretchElement( { element: this.dropdownMenu } );
		},
	...
	$(window).on('madxartwork/frontend/init', function () {
		...
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/pp-advanced-menu.default', AdvancedMenuHandler );
    });
