( function( $ ) {
	jQuery( window ).on( 'madxartwork:init', function() {
		...
		var preset_data = madxartwork.modules.controls.BaseData.extend({
			...
			applyPresets: function ( presets_json ) {
				var e = madxartwork.getPanelView().getCurrentPageView().getOption( "editedElementView" );
				//Reset style.
		...
		madxartwork.addControlView( "pp-presets-style", preset_data );
	});
} )( jQuery ); 
