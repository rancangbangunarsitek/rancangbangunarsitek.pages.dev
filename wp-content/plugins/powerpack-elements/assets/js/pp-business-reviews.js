( function( $ ) {
	...
	$( window ).on( 'madxartwork/frontend/init', function () {
		...
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.default', WidgetPPReviewsHandler );

		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.classic', WidgetPPReviewsHandler );

		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/pp-business-reviews.card', WidgetPPReviewsHandler );
