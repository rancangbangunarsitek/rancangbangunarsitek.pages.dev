	...
	PPHeaderLayout = {
		...
		init: function () {
			var isEditMode = false,
				header = $('.pp-madxartwork-header[data-type=header]');
		...
		_doShrink: function () {
			...
			if (winTop > headerTop + headerHeight) {
				...
				if (!hasClass) {
					...
					this.header.find('.madxartwork-section').each(function () {
					...
					this.header.find('.madxartwork-column-wrap').each(function () {
		...
		_removeShrink: function () {
			var rows = this.header.find('.madxartwork-section'),
				modules = this.header.find('.madxartwork-column-wrap');
		...
		_setImageMaxHeight: function () {
			var head = $('head'),
				...
				styles = '',
				images = this.header.find('.madxartwork-element img');
			...
			images.each(function (i) {
				var image = $(this),
					height = image.height(),
					node = image.closest('.madxartwork-element').data('id'),
					className = 'madxartwork-element-' + node + '-img-' + i;
