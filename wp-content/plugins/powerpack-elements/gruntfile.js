	...
	grunt.initConfig({
		...
		addtextdomain: {
			options: {
				...
				updateDomains: ['power-pack', 'bb-powerpack', 'madxartwork', 'madxartwork-pro']  // List of text domains to replace.
			},
			target: {
				files: {
					src: [
                ...
                files: [
                    {
                        ...
                        src: [
							...
							'!**/classes/class-pp-woo-builder.php',
							'!**/classes/class-pp-woo-builder-preview.php',
							'!**/classes/class-pp-woo-helper.php',
                        ]
                    }
                ]
            }
