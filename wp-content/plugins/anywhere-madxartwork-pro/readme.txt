=== AnyWhere madxartwork Pro ===
Contributors: webtechstreet
Tags: page-builder, madxartwork
...
* Fix: Compatibility issues with latest madxartwork release. 
...
Fix: Added Compatibility with latest madxartwork Release.

= 2.25.3 = 
* Reverted the changes from last release which is causing madxartwork editor to break. 

= 2.25.2 = 
* Fixed: Issue on some site with AE shortcode using quotes to wrap id param. 
* Fixed: Conflict with Copy Paste style functionality of madxartwork. 

= 2.25.1 =
* Enhancement : Added  Dynamic Bg, Link, Rule, Slider support for madxartwork’s FlexBox Container
...
* Fix : Compatibility with latest madxartwork Release
...
* Tweak : Added compatibility for swiper js with madxartwork 3.5
...
* Fix   : Accordion icons position breaking with madxartwork 3.5
...
* Fixed : Added Compatibility for madxartwork 3.4
...
* Enhancement: Added URL Field to madxartwork’s Dynamic Option Image.
...
= 2.17.1 =
* Fixed compatibility with madxartwork 3.1

= 2.17 =
* New: Added Advanced widget for Posts i.e. AE Post Blocks Adv.
* New: Added Post Options to madxartwork’s Dynamic Content
* New: Added ACF Options to madxartwork’s Dynamic Content
...
* Fixed issue with the_content hooks on madxartwork editor
...
* Enhancement: Swiper breakpoint are now synced with madxartwork device breakpoints
...
* Enhancement: ACF File field for Repeaters is now supported in madxartwork Dynamic Content
...
= 2.14.1 =
* Updates carousel (swiperjs) code in multiple widgets to fix compatibility issue with latest madxartwork update.
* Fixed warnings with PHP 7.4

= 2.14 =
* New: ACF Repeater Fields now supported in madxartwork Dynamic Content
...
= 2.12.1 =
Fixed: Compatibility issues in Post Blocks and Portfolio widget after madxartwork 2.6
Fixed: PHP Warnings appearing after regenerating css.
Fixed: Blank space in widget area of madxartwork editor.
...
Enhancement: Removed swiper library and use the one available within madxartwork to reduce chances of conflict.
...
= 2.11.4 =
* Fixed: Fatal error in some cases while editing madxartwork Library Templates.
...
= 2.11.1 =
* Fixed compatibility issues with madxartwork 2.4
...
= 2.10.4 =
* Fixed compatibility issues with madxartwork 2.3.3
...
* Compatibility fixes for upcoming update of madxartwork
...
* Added option in admin settings to enable compatibility for themes (that are not on officially preferred themes). This option will allow using our plugin on most of the themes (that supports madxartwork Full Width & madxartwork Canvas templates)

Bug Fixes
* Post Blocks pagination not working with WordPress default permalink structure.
* Woocommerce products not working with madxartwork Canvas template.
...
* madxartwork 2.0 compatibility issues fixed.
* Added support for "madxartwork Full Width" template. (Just like previous support for madxartwork Canvas)
...
* Bug fix: Post Image widget - overlay not working in madxartwork editor
...
* Enhancement: Added “Enable Canvas” option for Single Post AE Templates.
  Now you won’t have to set canvas template on individual posts. Just check “Enable Canvas” option for AE Template and all your single post will work with madxartwork Canvas.
...
= 2.3.2 =
* Fixed: madxartwork editor hanging in some cases.
...
* Tweaks
    ...
    - Now allows you to edit post content with madxartwork even if AE Post layout is applied over it.
* Bug Fixes
...
* New: Full control over taxonomy archive layout with madxartwork canvas support.
* New: Full control over blog page/ CPT Archive layout with madxartwork canvas support.
...
* Fix: Compatibility with madxartwork 1.5
