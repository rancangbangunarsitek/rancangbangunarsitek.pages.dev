...
jQuery(document).on('click','.madxartwork-widget-ae-portfolio .ae-pagination-wrapper a, .madxartwork-widget-ae-portfolio .filter-items a',function(){
    ...
    //pid = e_wrapper.split('-')[1];
    pid = wrapper.closest('.madxartwork').data('madxartwork-id');
...
jQuery(document).on('click','.madxartwork-widget-ae-post-blocks-adv .ae-pagination-wrapper a, .madxartwork-widget-ae-post-blocks-adv .filter-items a',function(){

    var widget_wrapper = jQuery(this).closest('.madxartwork-widget-ae-post-blocks-adv');
        ...
        success: function (res) {
            ...
            if(wrapper.data('item-reveal-animation') == 'yes'){
                ...
                setTimeout( function(){
                    ...
                    var device = jQuery('body').data('madxartwork-device-mode');
...
jQuery(document).on('click', '.madxartwork-widget-ae-dynamic-calendar #ae-dynamic-calendar .ae-dc-prev', ae_dynamic_calendar_prev_month);
jQuery(document).on('click', '.madxartwork-widget-ae-dynamic-calendar #ae-dynamic-calendar .ae-dc-next', ae_dynamic_calendar_next_month);

function ae_dynamic_calendar_prev_month(e) {
    e.preventDefault();
    var widget_wrapper = jQuery(this).closest('.madxartwork-widget-ae-dynamic-calendar');
    var wrapper = jQuery(widget_wrapper).find('.ae-outer-wrapper');
...
function load_calendar(month, year, wrapper, widget_wrapper) {
    ...
    var wid = wrapper.data('wid');
    var pid = wrapper.data('pid');
    var wclass = '.madxartwork-element-' + wid;
...
function ae_element_reinitialize(wrapper) {
    ...
    /* wrapper.find('.madxartwork-widget-ae-acf-gallery').each(function(){
