...
class SwiperBase{
    ...
    constructor(data, wid, scope = null) {
        ...
        let swiper = [];
        let swiperContainer = '.madxartwork-element-' + wid + ' .ae-swiper-container';
        let active_breakpoints = madxartworkFrontend.config.responsive.activeBreakpoints;
        if (scope !== null) {
            wid = scope.data('id');
           // console.log(wid);
            const slideId = scope.find('.swiper-container').data('ae-slider-id');
            swiperContainer = '.madxartwork-element-' + wid + ' .ae-swiper-container[data-ae-slider-id="' + slideId + '"]'
        }
        const wclass = '.madxartwork-element-' + wid;
        ...
        if ('undefined' === typeof Swiper) {
            ...
            new asyncSwiper( jQuery( swiperContainer ), swiper).then((newSwiperInstance) => {
                ...
                madxartworkFrontend.hooks.doAction( `aepro/trigger/swiper/widget/${wid}`, mswiper);
            });
        } else {
            
            const mswiper = new Swiper('.madxartwork-element-' + wid + ' .ae-swiper-container', swiper);
        ...
        jQuery('.madxartwork-element-' + wid + ' .ae-swiper-container').css('visibility', 'visible');
        ...
        if (mswiper.length > 0) {
                ...
                mswiper.forEach(function (slider) {
                    ...
                    slider.on('slideChangeTransitionStart', function () {
                        ...
                        slider.$wrapperEl.find('.swiper-slide-duplicate').find('.madxartwork-invisible').each(function () {
                            // get settings
                ...
                mswiper.on('slideChangeTransitionStart', function () {
                    ...
                    // reveal animated widgets
                    mswiper.$wrapperEl.find('.swiper-slide-duplicate').find('.madxartwork-invisible').each(function () {
                        // get settings
                         madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });
    ...
    pause_on_hover_func(mswiper, pause_on_hover, wid) {
        jQuery('.madxartwork-element-' + wid + ' .ae-swiper-container').hover(function () {
...
const BgSliderHandler = ( $scope , $ ) => {
    ...
    if ($scope.children('.aepro-section-bs').children('.aepro-section-bs-inner').hasClass('edit-mode')) {
        ...
        if (ae_slider_id) {
            slider_wrapper = jQuery(".madxartwork-element-" + wid + "[data-ae_slider='" + ae_slider_id + "']").children('.aepro-section-bs').children('.aepro-section-bs-inner');
...
const DynamicBgHandler = function ($scope, $) {
    ...
    if ($scope.hasClass("madxartwork-element-edit-mode")) {
        var data = {
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-acf-flexible-content.carousel', AcfFlexibleCarousel);
    });
})( jQuery );
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-acf-flexible-content.grid', AcfFlexibleGrid);
    });
})( jQuery );
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-acf-gallery.justified', ACFGalleryJustified);
    });
})(jQuery);
...
(function($){
    const ACFGallerySmartGrid = ( $scope , $ ) => {
        ...
        if ($scope.find('.ae-acf-gallery-layout-smart-grid')) {
            ...
            if (($('body').data('madxartwork-device-mode') == 'tablet' || $('body').hasClass('madxartwork-device-tablet'))
                || ($('body').data('madxartwork-device-mode') == 'mobile' || $('body').hasClass('madxartwork-device-mobile'))) {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-acf-gallery.smart_grid', ACFGallerySmartGrid);
    });
})(jQuery);
...
(function($){
    ...
    const ACFRepeaterAccordionHandler = ($scope, $) => {
        ...
        const title = $scope.find('[data-tab-id="' + tid + '"] > .ae-accordion-item > .madxartwork-tab-title.ae-tab-title');
        ...
        (title).on('click', function (e) {
            ...
            if ($this.hasClass("ae-active")) {
                ...
                $this
                    .parent()
                    .parent()
                    .find(".madxartwork-tab-title.ae-tab-title")
                ...
                $this.next().slideDown(speed, 'linear', function () {
                    ...
                    /* $this.next().find('.madxartwork-section').each(function () {
                        madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });

                    $this.next().find('.madxartwork-column').each(function(){
                        madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    });
                    
                    $this.next().find('.madxartwork-widget').each(function(){
                        madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                    }); */
                });
            }
            ...
            // setTimeout(function () {
               ...
               /*  $this.siblings('.ae-tab-content').find('.madxartwork-widget-ae-acf-gallery').each(function () {
                    madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                });
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-acf-repeater.accordion',  ACFRepeaterAccordionHandler );
    });
...
( function( $ ) {
    ...
    const ACFRepeaterDefaultHandler = ($scope, $) => {
        ...
        if (_base__WEBPACK_IMPORTED_MODULE_0__["isEditMode"]) {
            const sections = $scope.find('.madxartwork-section');
            $.each(sections, function (key, $section) {
                Object(_dynamic_bg__WEBPACK_IMPORTED_MODULE_1__["default"])($($section), $);
            });

            const columns = $scope.find('.madxartwork-column');
    ...
    $(window).on('madxartwork/frontend/init', function () {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-acf-repeater.default', ACFRepeaterDefaultHandler);
    });
})(jQuery);
...
(function($){
    ...
    const tabsLoad = ($scope, $) => {
        ...
        if (document.body.dataset.madxartworkDeviceMode == 'mobile') {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-acf-repeater.tabs',   ACFRepeaterTabsHandler );
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-acf.wysiwyg', FoldToUnfold );
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-acf.text-area',   FoldToUnfold );
    });
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.term_post_loop', AeTaxonomyBlocksAccordionHandler);
    });
})(jQuery);
...
(function($){
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.card', AeTaxonomyBlocks);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-taxonomy-blocks.classic', AeTaxonomyBlocks);
    });
})(jQuery);
...
(function($){
    const AeDynamicCalendar = ($scope, $) => {
        ...
        if (madxartworkFrontend.isEditMode() || settings.listing_render == 'load') {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-dynamic-calendar.skin_1', AeDynamicCalendar);
    });
})(jQuery);
...
(function ($) {
        ...
        if ($scope.find('.ae-dynamic-map-wrapper').length) {
                ...
                marker_item.forEach(node => {
                    node.addEventListener('click', function (el) {
                        ...
                        if (document.querySelector(wclass + ' .ae-responsive-btn')) {
                            if (document.querySelector(wclass + ' .ae-listing-responsive-mode-yes.' + document.querySelector('body').dataset.madxartworkDeviceMode)) {
            ...
            if (document.querySelector(wclass + ' .ae-dynamic-map-wrapper').dataset.map_type === 'google_map') {
                ...
                const add_marker = ($marker_div, map) => {
                    ...
                    let icon = '<div class="ae-map-marker" id="temp"><img src="/wp-content/plugins/anywhere-madxartwork-pro/includes/assets/images/map-icon.png" /></div>';
                    ...
                    if ($marker_div.html()) {
                        ...
                        google.maps.event.addListener(marker, 'click', function (i) {
                            ...
                            if (settings['marker_click_action'] == 'info_window') {
                                ...
                                $scope.find('.madxartwork-widget').each(function () {
                                    madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
                                });
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-dynamic-map.default', DynamicMap );
    });
})(jQuery);
...
( function( $ ) {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-pods.file_gallery', PodsGallery );
    });
...
( function( $ ) {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.carousel', 	PostBlocksAdvHandler );
    });
...
(function($){
        ...
        (collapse_button).on('click',function(e){
            ...
            if(acc_status == role){
                ...
                title.each(function (index, element) {
                    ...
                    var content = $(element).next();
                    content.slideUp(speed);
                    //content.removeClass('madxartwork-active');
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.accordion',  PostBlockAdvAccordionHandler );
    });
...
(function ($) {
    ...
    const _ias =  ( $scope , $, grid ) => {
        ...
        ias.on('append.infiniteScroll', function(event, response, path, items) {
            ...
            /* Initialise ACF Gallery on Ajax */
           /*  $scope.find('.ae-post-item.appended .madxartwork-widget-ae-acf-gallery').each(function () {
                madxartworkFrontend.elementsHandler.runReadyTrigger($(this));
            }); */

            $scope.find('.ae-post-item.appended .madxartwork-section').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            $scope.find('.ae-post-item.appended .madxartwork-column').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            $scope.find('.ae-post-item.appended .madxartwork-widget').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    ...
    const PostBlocksAdvHandler = ($scope, $) => {
        ...
        var device_mode = jQuery('body').data('madxartwork-device-mode');

        //madxartwork Editor
        if (madxartworkFrontend.isEditMode()) {
            device_mode = madxartwork.channels.deviceMode.request('currentMode');
            var filter = $scope.find('.aep-filter-bar.' + device_mode);
            $scope.find('.aep-filter-bar').hide();
            filter.show();
            madxartwork.channels.deviceMode.on('change', function(){
                device_mode = madxartwork.channels.deviceMode.request('currentMode');
        ...
        let $hashtag = window.location.hash.substring(1);
        if ($hashtag) {
            let device = jQuery('body').data('madxartwork-device-mode');
    ...
    $(document).on('click', '.facetwp-template.madxartwork-widget-ae-post-blocks-adv .ae-pagination-wrapper a', function(e) {
        e.preventDefault();
    ...
    if(jQuery('.ae-outer-wrapper').parents('.facetwp-template ').length > 0 ) {
        ...
        $(document).on('facetwp-loaded', function () {
            var widget_wrapper = jQuery('.facetwp-template.madxartwork-widget-ae-post-blocks-adv');
            var wrapper = jQuery('.ae-outer-wrapper');
            var ae_post_overlay = wrapper.siblings('.ae-post-overlay');
                    ...
                    if (disable_scroll_on_ajax_load == 'no') {
                        if (facetWP_flag) {
                           var settings = widget_wrapper.data('settings');
                            ...
                            if (document.body.dataset.madxartworkDeviceMode != 'desktop') {
                                pagination_scroll_top_offset = settings['grid_pagination_scroll_top_offset_' + document.body.dataset.madxartworkDeviceMode]['size'];
                            }
    ...
    if ($('.searchandfilter').length > 0) {
        $(document).on("sf:ajaxfinish", ".searchandfilter", function () {
            ...
            wrapper.find('.madxartwork-section').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            wrapper.find('.madxartwork-column').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            wrapper.find('.madxartwork-widget').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    }
...
(function($){
    ...
    const PostBlocksAdvTabsHandler = ( $scope, $ ) => {
        ...
        $tabsTitles.on( 'click', function() {
            ...
            /* Initialise ACF Gallery on Ajax */
            $tabs.find('.madxartwork-widget-ae-acf-gallery').each(function () {
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
        });
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-post-blocks-adv.tabs',   PostBlocksAdvTabsHandler );
    });
})(jQuery);
...
( function( $ ) {
    ...
    const _ias =  ( $scope , $, grid ) => {
        ...
        ias.on('append.infiniteScroll', function(event, response, path, items) {
            ...
            /* Initialise ACF Gallery on Ajax */
           /*  $scope.find('.ae-post-list-item.appended .madxartwork-widget-ae-acf-gallery').each(function () {
                madxartworkFrontend.elementsHandler.runReadyTrigger($(this));
            }); */

            $scope.find('.ae-post-list-item.appended .madxartwork-section').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });

            $scope.find('.ae-post-list-item.appended .madxartwork-column').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
            
            $scope.find('.ae-post-list-item.appended .madxartwork-widget').each(function(){
                madxartworkFrontend.elementsHandler.runReadyTrigger(jQuery(this));
            });
...
(function ($) {
        ...
        jQuery.each(trigger_targets, function (i, trigger_target) {
            ...
            Array.from(wrapper).forEach((el) => {
                ...
                if (trigger_data.trigger_type == 'carousel') {
                    let $mswiper = document.querySelector('.madxartwork-element-' + trigger_target + ' .ae-swiper-container').swiper;
                ...
                if (trigger_data.trigger_type == 'carousel') {
                    ...
                    switch (trigger_data.trigger_action) {
                        ...
                        case 'first_slide':
                            ...
                            break;
                        case 'last_slide':
                            var totalSlides = $('.madxartwork-element-' + trigger_target + ' .ae-swiper-container .swiper-slide:not(.swiper-slide-duplicate)').length;
            ...
            //For Accordions
            const accordion = $('.madxartwork-element-' + trigger_target);
            ...
            if (widget_type === 'ae-acf-repeater.accordion') {
                active_class = 'madxartwork-active';
            }
            ...
            $scope.find('.ae-trigger').on('click', function (e) {
                ...
                if (trigger_data.trigger_type == 'accordion') {
                    $scope.find('.ae-triggers').removeClass('active');
                    $this.parent('.ae-triggers').addClass('active');
                    const el_target = $('.madxartwork-element-' + trigger_target);
                    const title = $('.madxartwork-element-' + trigger_target + ' .ae-tab-title');
                    var content = $('.madxartwork-element-' + trigger_target + ' .ae-tab-content');
                    const speed = $scope.find('.ae-accordion').data('transition-speed');
                    switch (trigger_data.trigger_action) {
    ...
    $(window).on('load', function () {
        const widget_triggers = $('.madxartwork-widget-ae-trigger');
...
( function( $ ) {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction( 'frontend/element_ready/ae-woo-products.carousel', 	 WooProductCarousel );
    });
...
var WooProductImgeGallery = function ( $scope, $ ) {
    ...
    $(window).on( 'madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/ae-woo-gallery.default', WooProductImgeGallery);
    });
