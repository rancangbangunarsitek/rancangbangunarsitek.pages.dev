...
class Module extends madxartworkModules.Module {
  onInit() {
...
var _madxartworkFontManager = _interopRequireDefault(__webpack_require__(/*! ./admin/madxartwork-font-manager */ "../modules/assets-manager/assets/js/admin/madxartwork-font-manager.js"));
var _madxartworkCustomIcons = _interopRequireDefault(__webpack_require__(/*! ./admin/madxartwork-custom-icons */ "../modules/assets-manager/assets/js/admin/madxartwork-custom-icons.js"));
module.exports = function () {
  const TypekitAdmin = __webpack_require__(/*! ./admin/typekit */ "../modules/assets-manager/assets/js/admin/typekit.js"),
    CustomIcon = _madxartworkCustomIcons.default,
  ...
  this.fontManager = new _madxartworkFontManager.default();
...
exports["default"] = void 0;
class CustomAssetsBase extends madxartworkModules.ViewModule {
  showAlertDialog(id, message) {
    ...
    if (!this.alertWidget) {
      this.alertWidget = madxartworkCommon.dialogsManager.createWidget('alert', alertData);
    }
...
/***/ "../modules/assets-manager/assets/js/admin/madxartwork-custom-icons.js":
/*!***************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/madxartwork-custom-icons.js ***!
  \***************************************************************************/
...
var _madxartworkProDropzone = _interopRequireDefault(__webpack_require__(/*! ./fields/madxartwork-pro-dropzone */ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-dropzone.js"));
class CustomIcons extends _customAssetsBase.default {
  getDefaultSettings() {
    return {
      fields: {
        dropzone: _madxartworkProDropzone.default
      },
      classes: {
        editPageClass: 'post-type-madxartwork_icons',
        editPhp: 'edit-php',
        hasIcons: 'madxartwork--has-icons'
      },
      selectors: {
        editPageClass: 'post-type-madxartwork_icons',
        title: '#title',
        metaboxContainer: '#madxartwork-custom-icons-metabox',
        metabox: '.madxartwork-custom-icons-metabox',
        closeHandle: 'button.handlediv',
        iconsTemplate: '#madxartwork-icons-template',
        dataInput: '#madxartwork_custom_icon_set_config',
        dropzone: '.zip_upload',
        ...
        iconSetConfigInput: '#madxartwork_custom_icon_set_config'
      },
      templates: {
        icon: '<li><div class="icon"><i class="{{icon}}"></i><div class="icon-name">{{label}}</div></div></li>',
        header: jQuery('#madxartwork-custom-icons-template-header').html(),
        footer: jQuery('#madxartwork-custom-icons-template-footer').html(),
        duplicatePrefix: jQuery('#madxartwork-custom-icons-template-duplicate-prefix').html()
      },
      notice: __('Upload an icon set to publish.', 'madxartwork-pro')
    };
  }
  getDefaultElements() {
    const elements = {},
  ...
  prepareIconName(icon) {
    ...
    return madxartworkCommon.helpers.upperCaseWords(iconName);
  }
  getCreatedOn() {
    const {
      $dayInput,
  ...
  enqueueCSS(url) {
    if (!madxartworkCommon.elements.$document.find('link[href="' + url + '"]').length) {
      madxartworkCommon.elements.$document.find('link').last().after('<link href="' + url + '" rel="stylesheet" type="text/css">');
    }
  }
  setData(data) {
  ...
  renderIconList(config) {
    ...
    return config.icons.map(icon => {
      ...
      return madxartworkCommon.compileTemplate(iconTemplate, data);
    }).join('\n');
  }
  renderIcons(config) {
    const {
    ...
    $metabox.html('');
    $metaboxContainer.prepend(madxartworkCommon.compileTemplate(header, config));
    $metabox.append('<ul>' + this.renderIconList(config) + '</ul>');
    $metaboxContainer.append(madxartworkCommon.compileTemplate(footer, this.getCreatedOn()));
  }
  onTitleInput(event) {
...
/***/ "../modules/assets-manager/assets/js/admin/madxartwork-font-manager.js":
/*!***************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/madxartwork-font-manager.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = void 0;
var _customAssetsBase = _interopRequireDefault(__webpack_require__(/*! ./custom-assets-base */ "../modules/assets-manager/assets/js/admin/custom-assets-base.js"));
var _madxartworkProUpload = _interopRequireDefault(__webpack_require__(/*! ./fields/madxartwork-pro-upload */ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-upload.js"));
var _madxartworkProRepeater = _interopRequireDefault(__webpack_require__(/*! ./fields/madxartwork-pro-repeater */ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-repeater.js"));
class CustomFontsManager extends _customAssetsBase.default {
  getDefaultSettings() {
    return {
      fields: {
        upload: _madxartworkProUpload.default,
        repeater: _madxartworkProRepeater.default
      },
      selectors: {
        editPageClass: 'post-type-madxartwork_font',
        title: '#title',
        ...
        customFontsMetaBox: '#madxartwork-font-custommetabox',
        closeHandle: 'button.handlediv',
        toolbar: '.madxartwork-field-toolbar',
        inlinePreview: '.inline-preview',
        fileUrlInput: '.madxartwork-field-file input[type="text"]',
        postForm: '#post',
        publishButton: '#publish',
        publishButtonSpinner: '#publishing-action > .spinner'
      },
      notice: __('Choose a font to publish.', 'madxartwork-pro'),
  ...
  updateRowLabel(event, $table) {
    ...
    return this.renderTemplate(fontLabelTemplate, {
      ...
      preview: '<span style="' + previewStyle.styleAttribute + '">madxartwork is making the web beautiful</span>',
      toolbar: toolbarHtml
    });
  }
...
/***/ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-dropzone.js":
/*!**********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-dropzone.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = void 0;
class DropZoneField extends madxartworkModules.ViewModule {
  getDefaultSettings() {
    const baseSelector = '.madxartwork-dropzone-field';
    return {
      droppedFiles: false,
      selectors: {
        ...
        browseButton: baseSelector + ' .madxartwork--dropzone--upload__browse',
        postId: '#post_ID'
      },
      classes: {
        drag: 'is-dragover',
  ...
  handleUpload() {
    ...
    madxartworkCommon.ajax.send('ajax', {
      data: ajaxData,
      cache: false,
  ...
  onInit() {
    super.onInit();
    madxartworkCommon.elements.$document.trigger('onDropzoneLoaded', [this]);
  }
}
...
/***/ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-repeater.js":
/*!**********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-repeater.js ***!
  \**********************************************************************************/
/***/ ((module) => {
...
module.exports = {
  selectors: {
    ...
    repeaterField: '.madxartwork-field-repeater'
  },
  counters: [],
...
/***/ "../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-upload.js":
/*!********************************************************************************!*\
  !*** ../modules/assets-manager/assets/js/admin/fields/madxartwork-pro-upload.js ***!
  \********************************************************************************/
/***/ ((module) => {
...
module.exports = {
  ...
  fileFrame: [],
  selectors: {
    uploadBtnClass: 'madxartwork-upload-btn',
    clearBtnClass: 'madxartwork-upload-clear-btn',
    uploadBtn: '.madxartwork-upload-btn',
    clearBtn: '.madxartwork-upload-clear-btn',
    inputURLField: '.madxartwork-field-file input[type="text"]'
  },
  hasValue() {
  ...
  setUploadParams(ext, name) {
    ...
    uploader.param('uploadTypeCaller', 'madxartwork-admin-font-upload');
...
class _default extends madxartworkModules.ViewModule {
  getDefaultSettings() {
    return {
      selectors: {
        button: '#madxartwork_pro_fa_pro_validate_button',
        kitIdField: '#madxartwork_font_awesome_pro_kit_id'
      }
    };
  }
  getDefaultElements() {
...
module.exports = function () {
  ...
  self.cacheElements = function () {
    this.cache = {
      $button: jQuery('#madxartwork_pro_typekit_validate_button'),
      $kitIdField: jQuery('#madxartwork_typekit-kit-id'),
      $dataLabelSpan: jQuery('.madxartwork-pro-typekit-data')
    };
  };
  ...
  self.fetchFonts = function () {
    ...
    jQuery.post(ajaxurl, {
      action: 'madxartwork_pro_admin_fetch_fonts',
      kit_id: kitID,
...
module.exports = function (key, fieldID) {
  ...
  self.cacheElements = function () {
    this.cache = {
      $button: jQuery('#madxartwork_pro_' + key + '_button'),
      $apiKeyField: jQuery('#madxartwork_pro_' + key),
      $apiUrlField: jQuery('#madxartwork_pro_' + fieldID)
    };
  };
  self.bindEvents = function () {
    this.cache.$button.on('click', function (event) {
...
module.exports = function () {
  var self = this;
  self.init = function () {
    jQuery(document).on('change', '.madxartwork-widget-template-select', function () {
      var $this = jQuery(this),
        templateID = $this.val(),
        $editButton = $this.parents('p').find('.madxartwork-edit-template'),
        type = $this.find('[value="' + templateID + '"]').data('type');
      if ('page' !== type) {
        // 'widget' is editable only from madxartwork page
        $editButton.hide();
        return;
      }
...
class _default extends madxartworkModules.Module {
  constructor() {
    var _madxartworkModules$adm;
    super();
    if (!((_madxartworkModules$adm = madxartworkModules.admin) !== null && _madxartworkModules$adm !== void 0 && _madxartworkModules$adm.MenuHandler)) {
      return;
    }
    new madxartworkModules.admin.MenuHandler({
      path: 'edit.php?post_type=madxartwork_library&tabs_group=popup&madxartwork_library_type=popup'
    });
  }
}
exports["default"] = _default;
...
module.exports = function () {
  ...
  self.cacheElements = function () {
    this.cache = {
      $checkBox: jQuery('input[name="madxartwork_exclude_user_roles[]"]'),
      $advanced: jQuery('#madxartwork_advanced_role_manager')
    };
  };
  self.bindEvents = function () {
  ...
  self.init = function () {
    if (!jQuery('body').hasClass('madxartwork_page_madxartwork-role-manager')) {
      return;
    }
    this.cacheElements();
    this.bindEvents();
...
module.exports = function () {
  var selectors = {
    templateTypeInput: '#madxartwork-new-template__form__template-type',
    locationWrapper: '#madxartwork-new-template__form__location__wrapper',
    postTypeWrapper: '#madxartwork-new-template__form__post-type__wrapper'
  };
  var elements = {
  ...
  var setElements = function () {
    jQuery.each(selectors, function (key, selector) {
      key = '$' + key;
      elements[key] = madxartworkNewTemplate.layout.getModal().getElements('content').find(selector);
    });
  };
  ...
  this.init = function () {
    if (!window.madxartworkNewTemplate) {
      return;
    }

    // Make sure the modal has already been initialized
    madxartworkNewTemplate.layout.getModal();
    run();
  };
...
jQuery(function () {
  madxartworkProAdmin.roleManager.advancedRoleManager.init();
});
})();
