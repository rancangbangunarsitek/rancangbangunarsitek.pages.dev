...
function App() {
  return /*#__PURE__*/_react.default.createElement("div", {
    id: "madxartwork-form-submissions"
  }, /*#__PURE__*/_react.default.createElement(_settingsContext.SettingsProvider, {
    value: window.madxartworkSubmissionsConfig
...
function BulkActionSelect(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("form", {
  ...
  }, __('Select bulk action', 'madxartwork-pro')), /*#__PURE__*/_react.default.createElement("select", {
    name: "action",
    value: value,
    ...
    value: "",
    disabled: true
  }, __('Bulk actions', 'madxartwork-pro')), props.actions.map(action => {
    ...
    value: __('Apply', 'madxartwork-pro')
  }));
}
...
function DateFilter(props) {
  ...
  const options = useMemo(() => {
    ...
    return [{
      label: __('All Time', 'madxartwork-pro'),
      value: 'all',
      filter: {
        before: null,
        after: null
      ...
      label: __('Today', 'madxartwork-pro'),
      value: 'today',
      filter: {
        before: null,
        after: format(now)
      ...
      label: __('Yesterday', 'madxartwork-pro'),
      value: 'yesterday',
      filter: {
      ...
      label: __('Last 7 days', 'madxartwork-pro'),
      value: 'last7',
      filter: {
        before: null,
      ...
      label: __('Last 30 days', 'madxartwork-pro'),
      value: 'last_30',
      filter: {
        before: null,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.label && /*#__PURE__*/_react.default.createElement("label", {
    ...
    type: "date",
    "aria-label": __('Start Date', 'madxartwork-pro'),
    ...
    type: "date",
    "aria-label": __('End Date', 'madxartwork-pro'),
...
const buttonContentOptions = {
  [_useExport.EXPORT_MODE_ALL]: __('Export All to CSV', 'madxartwork-pro'),
  [_useExport.EXPORT_MODE_FILTERED]: __('Export Filtered to CSV', 'madxartwork-pro'),
  [_useExport.EXPORT_MODE_SELECTED]: __('Export Selected to CSV', 'madxartwork-pro')
};
function ExportButton(props) {
  ...
  }), " \xA0", /*#__PURE__*/_react.default.createElement("span", null, " ", ProgressPercentage, "% "), " \xA0", __('Click to Cancel', 'madxartwork-pro')) : buttonContentOptions[props.mode]);
}
...
function FormActionsLog(props) {
  return /*#__PURE__*/_react.default.createElement(_postBox.default, {
    header: /*#__PURE__*/_react.default.createElement("h2", null, __('Actions Log', 'madxartwork-pro'))
  ...
  }, " ", __('No form actions.', 'madxartwork-pro'), " ")), props.actions.map(actionLog => {
    return /*#__PURE__*/_react.default.createElement("div", {
...
function Notice(props) {
  ...
  }, __('Undo', 'madxartwork-pro')))), props.model.dismissible && /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    className: "notice-dismiss",
    onClick: props.dismiss
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "screen-reader-text"
  }, __('Dismiss this notice.', 'madxartwork-pro'))));
}
Notice.propTypes = {
...
function Pagination(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, props.total, " ", __('items', 'madxartwork-pro')), 1 < props.lastPage && /*#__PURE__*/_react.default.createElement("span", {
    ...
    className: "screen-reader-text"
  }, __('Current Page', 'madxartwork-pro')), /*#__PURE__*/_react.default.createElement("span", {
    className: "paging-input",
    style: {
      margin: '0 6px'
    }
  ...
  }, props.currentPage, " ", __('of', 'madxartwork-pro'), /*#__PURE__*/_react.default.createElement("span", {
...
function renderSelect2(el, onChange) {
  jQuery(el).select2({
    allowClear: true,
    placeholder: __('All Pages', 'madxartwork-pro'),
...
function RefererFilter(props) {
  const [options, setOptions] = useState([{
    value: '',
    label: __('All Pages', 'madxartwork-pro')
  }]);
  const ref = useRef();
  useEffect(() => {
    let $select2 = null;
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("label", {
    ...
    className: "screen-reader-text"
  }, __('Filter by Page', 'madxartwork-pro')), /*#__PURE__*/_react.default.createElement("select", {
    ref: ref,
...
function SearchBox(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("p", {
    ...
    value: localValue,
    onChange: onChange,
    placeholder: __('Search...', 'madxartwork-pro')
  }));
}
SearchBox.propTypes = {
  value: PropTypes.string,
...
function SubmissionRow(props) {
  ...
  const mainValue = ((_props$item = props.item) === null || _props$item === void 0 ? void 0 : (_props$item$main = _props$item.main) === null || _props$item$main === void 0 ? void 0 : _props$item$main.value) || __('Unknown', 'madxartwork-pro');
  return /*#__PURE__*/_react.default.createElement(_wpTable.default.Row, {
    ...
    className: "screen-reader-text"
  }, __('Show more details', 'madxartwork-pro')))), /*#__PURE__*/_react.default.createElement(_wpTable.default.Cell, {
    ...
    title: `${props.item.actions_succeeded_count}/${props.item.actions_count} ${__('Succeed', 'madxartwork-pro')}`
  })), /*#__PURE__*/_react.default.createElement(_wpTable.default.Cell, {
...
const ZIP_NAME_FORMAT = 'madxartwork-submissions-export-{DATE}';
const EXPORT_FILE_NAME_FORMAT = 'madxartwork-submissions-export-{FORM_LABEL}-{DATE}';
...
const generalError = () => __('Something went wrong, please try again later.', 'madxartwork-pro');
var _default = {
  trashed: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission moved to Trash.', '%d submissions moved to Trash.', count, 'madxartwork-pro'), count);
    },
    error: generalError
  },
  deleted: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission permanently deleted.', '%d submissions permanently deleted.', count, 'madxartwork-pro'), count);
    },
    error: generalError
  },
  updated: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('Submission has been successfully updated.', '%d submissions have been successfully updated.', count, 'madxartwork-pro'), count);
    },
    error: generalError
  },
  restored: {
    success: function () {
      let count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      return (0, _i18n.sprintf)((0, _i18n._n)('%d submission restored from Trash.', '%d submissions restored from Trash.', count, 'madxartwork-pro'), count);
    },
    error: generalError
  },
  markedAsRead: {
  ...
  actionLogs: {
    success: () => __('Action completed successfully.', 'madxartwork-pro'),
    failed: () => __('Action failed to run, please check your integration.', 'madxartwork-pro')
  }
};
...
const STATUSES = [{
  value: 'all',
  label: __('All', 'madxartwork-pro')
}, {
  value: 'unread',
  label: __('Unread', 'madxartwork-pro')
}, {
  value: 'read',
  label: __('Read', 'madxartwork-pro')
}, {
  value: 'trash',
  label: __('Trash', 'madxartwork-pro')
}];
function Index() {
  ...
  const rowActions = useMemo(() => [{
    ...
    key: 'restore',
    label: __('Restore', 'madxartwork-pro'),
    ...
    key: 'delete',
    label: __('Delete Permanently', 'madxartwork-pro'),
    onApply: item => deleteItems({
      id: item.id,
      force: 1
    }),
    ...
    key: 'read',
    label: __('Mark as Read', 'madxartwork-pro'),
    ...
    key: 'unread',
    label: __('Mark as Unread', 'madxartwork-pro'),
    onApply: item => updateRead({
      id: item.id
    }, false),
    shouldShow: item => 'trash' !== item.status && item.is_read
  ...
  const bulkActions = useMemo(() => {
    return [{
      ...
      label: __('Move to Trash', 'madxartwork-pro'),
      value: 'trash',
      onApply: () => deleteItems({
        ids: checked
      }),
  ...
  const tableTitles = useMemo(() => ({
    main_meta_id: {
      label: __('Main', 'madxartwork-pro'),
      className: 'column-primary'
    },
    actions_log_status: {
      label: __('Actions Status', 'madxartwork-pro'),
      className: 'column-actions'
    },
    form: {
    ...
    created_at: {
      label: __('Submission Date', 'madxartwork-pro'),
      className: 'column-date'
    }
  }), []);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_searchBox.default, {
    ...
    options: [{
      value: '',
      label: __('All Forms', 'madxartwork-pro')
    }],
    resourceOptions: {
      type: 'resource',
      command: 'forms/index',
    ...
    name: 'form',
    label: __('Filter by form', 'madxartwork-pro')
    ...
    label: __('Filter by date', 'madxartwork-pro'),
    name: "date"
    ...
    colSpan: 7
  }, __('No submissions found.', 'madxartwork-pro'))), data.map(item => {
...
function Item(props) {
  ...
  if (!Object.keys(data).length) {
    if (error) {
      return /*#__PURE__*/_react.default.createElement("p", null, " ", error.message || __('Not Found', 'madxartwork-pro'), " ");
    }
    return __('Loading...', 'madxartwork-pro');
  }
  return /*#__PURE__*/_react.default.createElement("div", {
    id: "poststuff"
    ...
    }, /*#__PURE__*/_react.default.createElement("h2", null, __('Submission', 'madxartwork-pro'), " #", data.id), /*#__PURE__*/_react.default.createElement("button", {
      onClick: e => {
        e.preventDefault();
    ...
    }, isEditMode ? __('Cancel', 'madxartwork-pro') : __('Edit', 'madxartwork-pro')))
    ...
    colSpan: "2"
  }, __('No data', 'madxartwork-pro'))))))), data.form_actions_log && /*#__PURE__*/_react.default.createElement(_formActionsLog.default, {
    actions: data.form_actions_log
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "postbox-container",
    id: "postbox-container-1"
  }, /*#__PURE__*/_react.default.createElement(_postBox.default, {
    header: /*#__PURE__*/_react.default.createElement("h2", null, __('Additional Info', 'madxartwork-pro'), " ")
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "submitbox"
  }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Form:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("a", {
    href: data.post.edit_url,
    target: "_blank",
    rel: "noreferrer"
  }, data.form.name, " (#", data.form.element_id, ")")), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('Page:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("a", {
    href: data.referer,
    target: "_blank",
    rel: "noreferrer"
    ...
    className: "misc-pub-section"
  }, __('Create Date:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, (0, _date.formatToLocalDateTime)(data.created_at))), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('Update Date:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, (0, _date.formatToLocalDateTime)(data.updated_at))), data.user_name && /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User Name:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_name)), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User IP:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_ip)), /*#__PURE__*/_react.default.createElement("div", {
    className: "misc-pub-section"
  }, __('User Agent:', 'madxartwork-pro'), " ", /*#__PURE__*/_react.default.createElement("strong", null, data.user_agent))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, isTrashEnabled ? __('Move to Trash', 'madxartwork-pro') : __('Delete Permanently', 'madxartwork-pro'))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Update', 'madxartwork-pro'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "clear"
...
const AppWrapper = madxartworkCommon.config.isDebug ? _react.default.StrictMode : _react.default.Fragment;
