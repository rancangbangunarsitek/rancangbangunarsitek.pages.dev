...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["mega-menu-editor"],{
...
class MegaMenu extends madxartwork.modules.elements.types.NestedElementBase {
  getType() {
    return 'mega-menu';
  }
}
...
class Module {
  constructor() {
    madxartwork.elementsManager.registerElementType(new _megaMenu.default());
  }
}
