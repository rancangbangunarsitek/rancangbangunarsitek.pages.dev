...
class Preview extends madxartworkModules.ViewModule {
  constructor() {
    super();
    madxartworkFrontend.on('components:init', () => this.onFrontendComponentsInit());
  }
  createDocumentsHandles() {
    jQuery.each(madxartworkFrontend.documentsManager.documents, (index, document) => {
      const element = document.$element.get(0),
        {
          madxartworkTitle: title
        } = element.dataset,
      ...
      (0, _documentHandle.default)({
        ...
        title,
        id
      }, _documentHandle.EDIT_CONTEXT, null, '.madxartwork-' + id);
    });
  }
  onFrontendComponentsInit() {
    this.createDocumentsHandles();
    madxartwork.on('document:loaded', () => this.createDocumentsHandles());
  }
}
exports["default"] = Preview;
window.madxartworkProPreview = new Preview();
})();
