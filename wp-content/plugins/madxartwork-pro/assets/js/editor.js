...
module.exports = madxartworkModules.editor.utils.Module.extend({
  ...
  addControlSpinner(controlName) {
    ...
    if ($el.find('.madxartwork-control-spinner').length) {
      return;
    }
  ...
  addControlError(controlName, error) {
    let location = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.madxartwork-control-content';
    const $el = this.getEditorControlView(controlName).$el;
    ...
    $el.find(location).first().after(`<span class="madxartwork-control-field-description e-control-error">${error}</span>`);
  },
  /**
...
class Module extends madxartworkModules.editor.utils.Module {
  onmadxartworkInit() {
...
class _default extends madxartworkModules.editor.utils.Module {
  addCustomCss(css, context) {
    ...
    let selector = '.madxartwork-element.madxartwork-element-' + model.get('id');
    if ('document' === model.get('elType')) {
      selector = madxartwork.config.document.settings.cssWrapperSelector;
    }
    if (customCSS) {
  ...
  onNavigatorInit() {
    madxartwork.navigator.indicators.customCSS = {
      ...
      title: __('Custom CSS', 'madxartwork-pro'),
...
module.exports = class extends madxartwork.modules.controls.Repeater {
  className() {
    let classes = super.className();
    classes += ' madxartwork-control-type-repeater';
    return classes;
  }
  getChildView() {
...
exports["default"] = void 0;
class _default extends madxartwork.modules.controls.RepeaterRow {
  ...
  toggleStepField(isStep) {
    this.$el.toggleClass('madxartwork-repeater-row--form-step', isStep);
  }
  toggleTools(show) {
...
class FormFieldsSanitizeCustomId extends $e.modules.hookData.Dependency {
  ...
  getId() {
    return 'madxartwork-pro-forms-fields-sanitize-custom-id';
  }
  getContainerType() {
    return 'repeater';
  }
...
class FormFieldsSetCustomId extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-forms-fields-set-custom-id';
  }
  getContainerType() {
    return 'widget';
  }
...
class FormFieldsAddFirstStep extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-forms-fields-first-step';
  }
  getContainerType() {
    return 'repeater';
  }
...
class FormSanitizeId extends $e.modules.hookData.Dependency {
  ...
  getId() {
    return 'madxartwork-pro-forms-sanitize-id';
  }
  getContainerType() {
    return 'widget';
  }
...
class FormFieldsUpdateShortCode extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-forms-fields-update-shortcode';
  }
  getContainerType() {
    return 'repeater';
  }
...
module.exports = BaseIntegrationModule.extend({
  ...
  updateFieldsMapping() {
    ...
    var remoteFields = [{
      remote_label: __('Email', 'madxartwork'),
      remote_type: 'email',
      remote_id: 'email',
      remote_required: true
    }, {
      remote_label: __('First Name', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'first_name',
      remote_required: false
    }, {
      remote_label: __('Last Name', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'last_name',
      remote_required: false
    }, {
      remote_label: __('Phone', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'phone',
      remote_required: false
    }, {
      remote_label: __('Organization name', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'orgname',
      remote_required: false
    }];
...
var ElementEditorModule = __webpack_require__(/*! madxartwork-pro/editor/element-editor-module */ "../assets/dev/js/editor/element-editor-module.js");
...
module.exports = BaseIntegrationModule.extend({
  ...
  updateFieldsMapping() {
    ...
    const remoteFields = [{
      ...
      remote_label: __('Name', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'name',
      remote_required: false
    }, {
      ...
      remote_label: __('Company', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'company',
      remote_required: false
    }, {
      ...
      remote_label: __('Country', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'country',
      remote_required: false
    }, {
      remote_label: __('State', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'state',
      remote_required: false
    }, {
      remote_label: __('City', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'city',
      remote_required: false
    }, {
      remote_label: __('Zip', 'madxartwork'),
      remote_type: 'text',
      remote_id: 'zip',
      remote_required: false
    }];
...
class FormsModule extends madxartworkModules.editor.utils.Module {
  onmadxartworkInit() {
    ...
    madxartwork.addControlView('Fields_map', __webpack_require__(/*! ./fields-map-control */ "../modules/forms/assets/js/editor/fields-map-control.js"));
    madxartwork.addControlView('form-fields-repeater', __webpack_require__(/*! ./fields-repeater-control */ "../modules/forms/assets/js/editor/fields-repeater-control.js"));
  }
  onmadxartworkInitComponents() {
    $e.components.register(new _component.default({
      manager: this
    }));
  }
...
module.exports = madxartworkModules.editor.utils.Module.extend({
  ...
  getDataSettings(item) {
    const config = madxartworkPro.config.forms[item.field_type],
  ...
  var updateReplyToOptions = function () {
    ...
    emailFields = _.map(emailModels, function (model) {
      return {
        ...
        label: sprintf(__('%s Field', 'madxartwork-pro'), model.get('field_label'))
      };
    });
...
class SaveTemplates extends $e.modules.CommandInternalBase {
  ...
  getCurrentTemplatesModels(changedContainersId) {
    ...
    Object.entries(changedContainersId).forEach(_ref => {
      ...
      const container = madxartwork.getContainer(containerId);
      if (!container) {
        return;
      }
...
class Link extends $e.modules.document.CommandHistory {
  ...
  getHistory(args) {
    ...
    return {
      title: madxartwork.widgetsCache[data.widgetType].title,
      subTitle: data.title,
      type: __('Linked to Global', 'madxartwork-pro')
    };
  }
  apply(args) {
    const {
    ...
    containers.forEach(( /** Container */container) => {
      ...
      const elementModel = madxartworkPro.modules.globalWidget.addGlobalWidget(data.template_id, data),
...
class Unlink extends $e.modules.document.CommandHistory {
  ...
  getHistory(args) {
    ...
    return {
      title: madxartwork.helpers.getModelLabel(containers[0].model),
      // TODO: add support multi containers.
      type: __('Unlink Widget', 'madxartwork-pro')
    };
  }
  async apply(args) {
    const {
    ...
    containers.forEach(( /** Container */container) => {
      const id = container.model.get('templateID'),
        elementModel = madxartworkPro.modules.globalWidget.createGlobalModel(id, data[id]);
      $e.run('document/elements/create', {
        container: container.parent,
        model: {
          id: madxartwork.helpers.getUniqueID(),
          ...
          settings: madxartworkCommon.helpers.cloneObject(elementModel.get('settings').attributes),
          defaultEditSettings: madxartworkCommon.helpers.cloneObject(elementModel.get('editSettings').attributes)
        },
        options: {
...
class Component extends $e.modules.ComponentBase {
  ...
  updateGlobalsRecursive(targetContainer) {
    ...
    madxartwork.getPreviewContainer().forEachChildrenRecursive(container => {
      // Will skip self.
...
class GlobalWidgetPrepareUpdateElementSetSettings extends _baseGlobalWidgetPrepareUpdate.BaseGlobalWidgetPrepareUpdate {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-prepare-update-element-set-settings';
  }
}
...
class GlobalWidgetDoUpdate extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-do-update';
  }
  getConditions() {
...
class GlobalWidgetPrepareUpdateRepeaterInsert extends _baseGlobalWidgetPrepareUpdate.default {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-prepare-update-repeater-insert';
  }
}
...
class GlobalWidgetPrepareUpdateRepeaterRemove extends _baseGlobalWidgetPrepareUpdate.BaseGlobalWidgetPrepareUpdate {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-prepare-update-repeater-remove';
  }
}
...
class GlobalWidgetSaveTemplates extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-save-templates';
  }
  getConditions(args) {
    ...
    const {
      document = madxartwork.documents.getCurrent()
    } = args;
...
class GlobalWidgetLoadTemplates extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-load-templates';
  }
  getConditions() {
  ...
  apply() {
    ...
    Object.entries(madxartworkPro.config.widget_templates).forEach(_ref => {
      let [id, data] = _ref;
      madxartworkPro.modules.globalWidget.addGlobalWidget(id, data);
      this.addTemplateToCache(id);
    });
  }
  addTemplateToCache(id) {
    const container = madxartwork.getPreviewContainer().findChildrenRecursive(i => parseInt(i.model.get('templateID')) === parseInt(id));
    if (!container) {
...
class GlobalWidgetHistoryUpdate extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-global-widget-history-update';
  }
  getContainerType() {
    return 'widget';
  }
  getConditions(args) {
    ...
    return !madxartwork.documents.getCurrent().history.getActive() && containers.some(container => container.model.get('templateID'));
  }
  apply(args) {
    const {
      containers = [args.container]
...
class Module extends madxartworkModules.editor.utils.Module {
  ...
  createGlobalModel(templateId, templateData) {
    templateData = Object.assign({}, templateData, {
      id: templateId,
      categories: [],
      icon: madxartwork.widgetsCache[templateData.widgetType].icon,
      widgetType: templateData.widgetType,
      custom: {
        templateID: templateId
      }
    });
    const elementModel = new madxartwork.modules.elements.models.Element(templateData);
  ...
  registerTemplateType() {
    madxartwork.templates.registerTemplateType('widget', {
      showInLibrary: false,
      saveDialog: {
        title: __('Save your widget as a global widget', 'madxartwork-pro'),
        description: __('You\'ll be able to add this global widget to multiple areas on your site, and edit it from one single place.', 'madxartwork-pro')
      },
  ...
  getGlobalModels(id) {
    madxartworkCommon.helpers.softDeprecated('madxartworkPro.modules.globalWidget.getGlobalModels( id )', '3.5.0', '$e.data.getCache( `document/global/global-widget/templates/${ id }` )');
    return $e.data.getCache(this.component, `document/global/global-widget/templates/${id}`);
  }
  saveTemplates() {
    madxartworkCommon.helpers.softDeprecated('madxartworkPro.modules.globalWidget.saveTemplates()', '3.5.0', "$e.internal( 'document/global/save-templates' )");
    $e.internal('document/global/save-templates');
  }
  requestGlobalModelSettings(globalModel, callback) {
    madxartworkCommon.helpers.softDeprecated('madxartworkPro.modules.globalWidget.requestGlobalModelSettings()', '3.5.0', "$e.data.get( 'document/global/templates' )");
    $e.data.get('document/global/templates', {
      ids: globalModel.id
    }).then(data => {
      callback(data);
  ...
  setWidgetContextMenuSaveAction() {
    madxartwork.hooks.addFilter('elements/widget/contextMenuGroups', (groups, widget) => {
  ...
  onmadxartworkInit() {
    madxartwork.on('panel:init', () => {
      madxartwork.hooks.addFilter('panel/elements/regionViews', regionViews => {
  ...
  onmadxartworkPreviewLoaded(isFirst) {
    if (!isFirst) {
      return;
    }
    this.addPanelPage();
    $e.routes.register('panel/editor', 'global', args => {
      madxartwork.getPanelView().setPage('globalWidget', 'Global Editing', {
  ...
  onWidgetTemplateSaved(data) {
    ...
    const container = madxartwork.getContainer(madxartwork.templates.layout.modalContent.currentView.model.id);
...
module.exports = GlobalWidgetsView.extend({
  ...
  className: 'madxartwork-nerd-box madxartwork-panel-nerd-box e-responsive-panel-stretch'
});
...
module.exports = Marionette.ItemView.extend({
  ...
  buildUnlinkDialog() {
    ...
    return madxartworkCommon.dialogsManager.createWidget('confirm', {
      ...
      headerMessage: __('Unlink Widget', 'madxartwork-pro'),
      message: __('This will make the widget stop being global. It\'ll be reverted into being just a regular widget.', 'madxartwork-pro'),
      position: {
        my: 'center center',
        at: 'center center'
      },
      strings: {
        confirm: __('Unlink', 'madxartwork-pro'),
        cancel: __('Cancel', 'madxartwork-pro')
      },
      onConfirm() {
...
exports["default"] = void 0;
const ElementModel = madxartwork.modules.elements.models.Element;
class Model extends ElementModel {
  ...
  initSettingsFromTemplate() {
    const id = this.get('templateID'),
      ...
      elementModel = madxartworkPro.modules.globalWidget.createGlobalModel(id, data);
    this.set('settings', elementModel.get('settings'));
    madxartworkFrontend.config.elements.data[this.cid] = this.get('settings');
  }
}
...
exports["default"] = void 0;
const WidgetView = madxartwork.modules.elements.views.Widget;
class View extends WidgetView {
  className() {
    return super.className() + ' madxartwork-global-widget madxartwork-global-' + this.model.get('templateID');
  }
  ...
  getContainer() {
    ...
    container.label = container.label + ' (' + __('global', 'madxartwork-pro') + ')';
    return container;
  }
  render() {
    super.render();
  ...
  removeInlineAddingAttributes() {
    const globalWidgetElementDom = this.el.querySelector('.madxartwork-inline-editing');
    if (globalWidgetElementDom) {
      globalWidgetElementDom.classList.remove('madxartwork-inline-editing');
    }
  }
}
  ...
  self.onTemplateIdChange = function () {
    ...
    if ($editButton.length) {
      ...
      $editButton = jQuery('<a />', {
        ...
        href: editUrl,
        html: '<i class="eicon-pencil" /> ' + __('Edit Template', 'madxartwork-pro')
      });
...
var _documentHandle = _interopRequireWildcard(__webpack_require__(/*! madxartwork-pro/preview/utils/document-handle */ "../assets/dev/js/preview/utils/document-handle.js"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
class loopBuilderModule extends madxartworkModules.editor.utils.Module {
  onmadxartworkFrontendInit() {
    madxartworkFrontend.elements.$body.on('click', '.e-loop-empty-view__box-cta', () => {
      this.createTemplate();
    });
    this.createDocumentSaveHandles();
    madxartwork.on('document:loaded', this.createDocumentSaveHandles.bind(this));
  }
  createTemplate() {
    setTimeout(() => {
      madxartwork.getPanelView().getCurrentPageView().activateSection('section_layout')._renderChildren();
      this.getEditorControlView('template_id').createTemplate();
    });
  }
  createDocumentSaveHandles() {
    var _madxartworkFrontend$co, _madxartworkFrontend$co2;
    Object.entries((_madxartworkFrontend$co = madxartworkFrontend.config) === null || _madxartworkFrontend$co === void 0 ? void 0 : (_madxartworkFrontend$co2 = _madxartworkFrontend$co.elements) === null || _madxartworkFrontend$co2 === void 0 ? void 0 : _madxartworkFrontend$co2.data).forEach(_ref => {
      let [cid, element] = _ref;
      const elementData = madxartwork.getElementData(element);
      if (!(elementData !== null && elementData !== void 0 && elementData.is_loop)) {
        return;
      }
      const md = madxartworkFrontend.elements.$body.find('[data-model-cid="' + cid + '"]');
      if (!md.length) {
        return;
      }
      const masterItem = md.find('[data-madxartwork-type="loop-item"]').first();
      if (masterItem) {
        (0, _documentHandle.default)({
          element: masterItem,
          id: 0,
          title: '& Back'
        }, _documentHandle.SAVE_CONTEXT, null, '.madxartwork-' + madxartwork.config.initial_document.id);
      }
    });
  }
  onmadxartworkLoaded() {
    madxartwork.on('document:loaded', this.onDocumentLoaded.bind(this));
    madxartwork.on('document:unload', this.onDocumentUnloaded.bind(this));
  ...
  onDocumentLoaded(document) {
    ...
    madxartwork.channels.editor.on('madxartworkLoopBuilder:ApplySourceChange', this.onApplySourceChange);
  }
  onDocumentUnloaded(document) {
    if (!document.config.theme_builder) {
      return;
    }
    madxartwork.channels.editor.off('madxartworkLoopBuilder:ApplySourceChange', this.onApplySourceChange);
  }
  onApplySourceChange() {
  ...
  getCtaStyles() {
    ...
    ctaStyle.setAttribute('href', `${madxartworkAppProConfig.baseUrl}/assets/css/loop-grid-cta.css`);
    return ctaStyle;
  }
  getCtaContent(widgetName) {
    const ctaContent = document.createElement('div');
    ctaContent.classList.add('e-loop-empty-view__container', 'madxartwork-grid', widgetName);
...
class _default extends madxartworkModules.editor.utils.Module {
  ...
  onNavigatorInit() {
    madxartwork.navigator.indicators.motionFX = {
      icon: 'flash',
      title: __('Motion Effects', 'madxartwork-pro'),
...
class StripeModule extends madxartworkModules.editor.utils.Module {
  onmadxartworkInit() {
...
const ElementEditorModule = __webpack_require__(/*! madxartwork-pro/editor/element-editor-module */ "../assets/dev/js/editor/element-editor-module.js");
module.exports = ElementEditorModule.extend({
  __construct() {
    ElementEditorModule.prototype.__construct.apply(this, arguments);
  },
  ...
  onInit() {
    madxartwork.channels.editor.on('editor:widget:stripe-button:section_stripe_account:activated', this.onSectionActive);
  },
  onSectionActive() {
    return madxartworkPro.ajax.addRequest('get_stripe_tax_rates', {
      success: data => {
...
exports["default"] = void 0;
class _default extends madxartworkModules.editor.views.ControlsStack {
  constructor() {
    super(...arguments);
  ...
  className() {
    return super.className() + ' madxartwork-popup__display-settings';
  }
  ...
  onRender() {
    ...
    this.children.each(child => {
      ...
      const $imageWrapper = jQuery('<div>', {
          class: 'madxartwork-popup__display-settings_controls_group__icon'
        }),
        $image = jQuery('<img>', {
          src: madxartworkPro.config.urls.modules + `popup/assets/images/${name}/${groupName}.svg`
        });
...
class PopupSave extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-popup-save';
  }
  getConditions() {
    return 'popup' === madxartwork.config.document.type;
  }
  apply() {
    const settings = {};
    jQuery.each(madxartworkPro.modules.popup.displaySettingsTypes, (type, data) => {
...
class PopupRemoveInstructions extends _baseHookPopupAfter.default {
  ...
  getId() {
    return 'madxartwork-pro-popup-remove-instructions';
  }
  getConditions(args) {
    const {
      document
    } = args;
    return 'popup' === document.config.type && !madxartwork.config.user.introduction.popupSettings;
  }
  apply() {
...
class PopupRemoveLibraryTab extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-popup-remove-library-tab';
  }
  getConditions(args) {
    const {
      document
...
class PopupRemoveTriggers extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-popup-remove-triggers';
  }
  getConditions(args) {
    const {
      document
  ...
  removePanelFooterSubmenuItems() {
    const displaySettingsTypes = madxartworkPro.modules.popup.displaySettingsTypes;
    jQuery.each(displaySettingsTypes, type => {
      madxartwork.getPanelView().footer.currentView.removeSubMenuItem('saver-options', {
        name: type
      });
    });
  }
  removePublishTabs() {
    const component = $e.components.get('theme-builder-publish'),
      displaySettingsTypes = madxartworkPro.modules.popup.displaySettingsTypes;
    jQuery.each(displaySettingsTypes, type => {
...
class PopupAddInstructions extends _baseHookPopupAfter.default {
  ...
  getId() {
    return 'madxartwork-pro-popup-add-instructions';
  }
  getConditions(args) {
    const document = madxartwork.documents.get(args.id);
    return 'popup' === document.config.type && !madxartwork.config.user.introduction.popupSettings;
  }
  apply() {
  ...
  getIntroduction() {
    return new madxartworkModules.editor.utils.Introduction({
      introductionKey: 'popupSettings',
      dialogOptions: {
        id: 'madxartwork-popup-settings-introduction',
        headerMessage: '<i class="eicon-info"></i>' + __('Please Note', 'madxartwork-pro'),
        message: __('Popup settings are accessed via the settings icon in the bottom menu', 'madxartwork-pro'),
        closeButton: true,
...
class PopupAddLibraryTab extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-popup-add-library-tab';
  }
  getConditions(args) {
    const document = madxartwork.documents.get(args.id);
    return 'popup' === document.config.type;
...
class PopupAddTriggers extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-popup-add-triggers';
  }
  getConditions(args) {
    const document = madxartwork.documents.get(args.id);
    return 'popup' === document.config.type;
  ...
  apply() {
    if (madxartwork.panel) {
      this.addUI();
    } else {
      // First open, the panel is not available yet.
      madxartwork.on('preview:loaded', this.addUI.bind(this));
    }
  }
  addUI() {
  ...
  addPublishTabs() {
    const config = madxartwork.config.document.displaySettings,
      component = $e.components.get('theme-builder-publish'),
      module = madxartworkPro.modules.popup;
    jQuery.each(module.displaySettingsTypes, (type, data) => {
      // Init models for editor save.
      data.model = new madxartworkModules.editor.elements.models.BaseSettings(config[type].settings, {
...
class PopupModule extends madxartworkModules.editor.utils.Module {
  constructor() {
    super(...arguments);
    this.displaySettingsTypes = {
      triggers: {
        icon: 'eicon-click',
        title: __('Triggers', 'madxartwork-pro'),
        publishScreenDescription: __('What action the user needs to do for the popup to open.', 'madxartwork-pro')
      },
      timing: {
        icon: 'eicon-cog',
        title: __('Advanced Rules', 'madxartwork-pro'),
        publishScreenDescription: __('Requirements that have to be met for the popup to open.', 'madxartwork-pro')
      }
    };
  }
  onmadxartworkLoaded() {
...
module.exports = madxartworkModules.editor.utils.Module.extend({
  onmadxartworkPreviewLoaded() {
    madxartwork.addControlView('Query', __webpack_require__(/*! ./editor/query-control */ "../modules/query-control/assets/js/editor/query-control.js"));
    __webpack_require__.e(/*! import() */ "modules_query-control_assets_js_editor_template-query-control_js").then(__webpack_require__.bind(__webpack_require__, /*! ./editor/template-query-control */ "../modules/query-control/assets/js/editor/template-query-control.js")).then(_ref => {
      ...
      return madxartwork.addControlView('template_query', TemplateQueryControl);
    });
  }
});
...
module.exports = madxartwork.modules.controls.Select2.extend({
  ...
  getQueryData() {
    ...
    const autocomplete = madxartworkCommon.helpers.cloneObject(this.model.get('autocomplete'));
...
class DeleteScreenshot extends $e.modules.hookData.After {
  ...
  getConditions(args) {
    const {
      ...
      config = madxartwork.documents.getCurrent().config;
  ...
  apply() {
    const postId = madxartwork.documents.getCurrent().id;
    return madxartworkCommon.ajax.addRequest('screenshot_delete', {
...
class FocusPreview extends $e.modules.hookData.After {
  ...
  apply() {
    setTimeout(() => {
      madxartwork.$preview[0].contentWindow.scrollBy(0, 0);
    }, 100);
  }
}
...
module.exports = madxartworkModules.editor.utils.Module.extend({
  ...
  getNetworkClass(networkName) {
    ...
    if (madxartwork.config.icons_update_needed) {
...
module.exports = madxartwork.modules.controls.RepeaterRow.extend({
  ...
  initialize() {
    ...
    this.config = madxartwork.config.document.theme_builder;
  },
  updateOptions() {
...
module.exports = madxartwork.modules.controls.Repeater.extend({
  ...
  onRender() {
    this.ui.btnAddRow.text(__('Add Condition', 'madxartwork-pro'));
  }
});
...
var inlineControlsStack = __webpack_require__(/*! madxartwork-pro/editor/inline-controls-stack.js */ "../assets/dev/js/editor/inline-controls-stack.js");
...
class ThemeBuilderSaveAndReload extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-save-and-reload';
  }
  getContainerType() {
    return 'document';
  }
  ...
  apply() {
    $e.run('document/save/auto', {
      ...
      onSuccess: () => {
        ...
        madxartwork.once('preview:loaded', () => {
...
class ThemeBuilderUpdatePreviewOptions extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-update-preview-options';
  }
  getContainerType() {
    return 'document';
  }
...
class ThemeBuilderSaveConditions extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-save-conditions';
  }
  getConditions() {
    return !!madxartwork.config.document.theme_builder;
  }
  apply() {
    const {
      conditionsModel
    } = madxartworkPro.modules.themeBuilder;
    madxartworkPro.ajax.addRequest('theme_builder_save_conditions', {
      data: conditionsModel.toJSON({
        remove: ['default']
      }),
      success: () => {
        madxartwork.config.document.theme_builder.settings.conditions = conditionsModel.get('conditions');
      }
    });
  }
}
...
class ThemeBuilderShowConditions extends $e.modules.hookData.Dependency {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-show-conditions';
  }
  getConditions(args) {
    const {
      force = false
    ...
    const themeBuilder = madxartwork.config.document.theme_builder;
    if (themeBuilder) {
...
class ThemeBuilderPreviewBreak extends $e.modules.hookData.Dependency {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-preview-break';
  }
  getConditions(args) {
    ...
    return !!madxartwork.documents.get(args.id).config.theme_builder;
  }
  apply() {
    return false; // HookBreak.
  }
...
class ThemeBuilderToggleMenuConditions extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-toggle-menu-conditions';
  }
  getContainerType() {
    return 'document';
  }
  ...
  apply() {
    ...
    themeBuilder.ui.menuConditions.toggle(!!madxartwork.config.document.theme_builder.settings.location);
  }
}
...
class ThemeBuilderRemoveEditorUI extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-remove-editor-ui';
  }
  getConditions(args) {
    const {
      document
  ...
  removePanelFooterSubmenuItems() {
    const footerView = madxartwork.getPanelView().footer.currentView,
      behavior = footerView._behaviors[Object.keys(footerView.behaviors()).indexOf('saver')];
    madxartwork.getPanelView().footer.currentView.removeSubMenuItem('saver-options', {
      name: 'conditions'
    });
    behavior.ui.buttonPreview.tipsy('enable').removeClass('madxartwork-panel-footer-theme-builder-buttons-wrapper madxartwork-toggle-state');
  }
  removePublishTabs() {
    const component = $e.components.get('theme-builder-publish');
...
class ThemeBuilderAddEditorUI extends $e.modules.hookUI.After {
  ...
  getId() {
    return 'madxartwork-pro-theme-builder-add-editor-ui';
  }
  getConditions(args) {
    return madxartwork.documents.get(args.id).config.theme_builder;
  }
  apply() {
    if (madxartwork.panel) {
      ...
      // First open, the panel is not available yet.
      madxartwork.once('preview:loaded', this.addUI.bind(this));
    }
  }
  addUI() {
  ...
  addRepeaterControlView() {
    madxartwork.addControlView('Conditions_repeater', __webpack_require__(/*! ../../../../../conditions/repeater */ "../modules/theme-builder/assets/js/editor/conditions/repeater.js"));
  }
  addPublishTabs() {
    const component = $e.components.get('theme-builder-publish'),
      themeBuilderModuleConfig = madxartwork.config.document.theme_builder,
      settings = themeBuilderModuleConfig.settings;
    component.manager.conditionsModel = new madxartworkModules.editor.elements.models.BaseSettings(settings, {
      controls: themeBuilderModuleConfig.template_conditions.controls
    });
    component.addTab('conditions', {
      title: __('Conditions', 'madxartwork-pro'),
      View: _view.default,
      viewOptions: {
      ...
      name: 'conditions',
      description: __('Apply current template to these pages.', 'madxartwork-pro'),
  ...
  addPanelFooterSubmenuItems() {
    ...
    footerView.ui.menuConditions = footerView.addSubMenuItem('saver-options', {
      ...
      name: 'conditions',
      icon: 'eicon-flow',
      title: __('Display Conditions', 'madxartwork-pro'),
      callback: () => $e.route('theme-builder-publish/conditions')
    });
    footerView.ui.menuConditions.toggle(!!madxartwork.config.document.theme_builder.settings.location);
    behavior.ui.buttonPreview.tipsy('disable').html(jQuery('#tmpl-madxartwork-theme-builder-button-preview').html()).addClass('madxartwork-panel-footer-theme-builder-buttons-wrapper madxartwork-toggle-state');
  }
}
...
class ThemeBuilderFooterSaverAfterSave extends $e.modules.hookUI.After {
  ...
  getConditions() {
    return madxartwork.config.document.support_site_editor;
  }
  apply(args, result) {
    const {
      status
  ...
  onPageStatusChange(newStatus) {
    ...
    const options = {
      ...
      buttons: [{
        ...
        text: '<i class="eicon-external-link-square"></i><span class="e-theme-builder-toaster-button-text">' + __('Open Site Editor', 'madxartwork-pro') + '</span>',
        callback() {
          $e.run('app/open');
        }
      }, {
        name: 'view_live_site',
        text: '<i class="eicon-preview-medium"></i><span class="e-theme-builder-toaster-button-text">' + __('View Live Site', 'madxartwork-pro') + '</span>',
        callback() {
          open(madxartwork.config.document.urls.permalink);
        }
      }]
    };
    madxartwork.notifications.showToast(options);
  }
}
...
class ThemeBuilderModule extends madxartworkModules.editor.utils.Module {
  __construct() {
    super.__construct(...arguments);
    Object.defineProperty(madxartworkPro.config, 'theme_builder', {
      get() {
        madxartworkCommon.helpers.softDeprecated('theme_builder', '2.9.0', 'madxartwork.config.document.theme_builder');
        return madxartwork.config.document.theme_builder;
      }
    });
  }
  onmadxartworkLoaded() {
    ...
    madxartwork.channels.editor.on('madxartworkProSiteLogo:change', this.openSiteIdentity);
  }
  onDocumentLoaded(document) {
    if (!document.config.theme_builder) {
      return;
    ...
    madxartwork.channels.editor.on('madxartworkThemeBuilder:ApplyPreview', this.onApplyPreview);
  ...
  onDocumentUnloaded(document) {
    ...
    madxartwork.getPanelView().off('set:page:page_settings', this.updatePreviewIdOptions);
    madxartwork.channels.editor.off('madxartworkThemeBuilder:ApplyPreview', this.onApplyPreview);
    madxartwork.channels.editor.off('page_settings:preview_settings:activated', this.onSectionPreviewSettingsActive);
  }
  saveAndReload() {
    $e.run('document/save/auto', {
      force: true,
      onSuccess: () => {
        ...
        const isInitialDocument = madxartwork.config.initial_document.id === madxartwork.documents.getCurrentId();
  ...
  updatePreviewIdOptions(render) {
    let previewType = madxartwork.settings.page.model.get('preview_type');
    if (!previewType) {
      return;
    }
    previewType = previewType.split('/');
    const currentView = madxartwork.getPanelView().getCurrentPageView(),
  ...
  defaultCommands() {
    return {
      ...
      'preview-settings': () => {
        ...
        const panel = madxartwork.getPanelView();
        $e.route('panel/page-settings/settings');
...
exports["default"] = void 0;
class _default extends madxartworkModules.common.views.modal.Layout {
  getModalOptions() {
    return {
  ...
  getLogoOptions() {
    return {
      title: __('Publish Settings', 'madxartwork-pro')
    };
  }
  initModal() {
    super.initModal();
    this.modal.addButton({
      name: 'publish',
      text: __('Save & Close', 'madxartwork-pro'),
      callback: () => $e.run('theme-builder-publish/save')
    });
    this.modal.addButton({
      name: 'next',
      text: __('Next', 'madxartwork-pro'),
...
class Module extends madxartworkModules.editor.utils.Module {
  ...
  onmadxartworkLoaded() {
    madxartwork.channels.editor.on('madxartworkPlaylistWidget:setVideoData', e => {
      $e.run('document/elements/settings', {
...
class WoocommerceCreateWidgetActivateSettingsModal extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-woocommerce-create-widget-activate-settings-modal';
  }
  getContainerType() {
    return 'column';
  }
  getConditions(args, container) {
    return Object.prototype.hasOwnProperty.call(madxartworkPro.modules.woocommerce.pageSettingsWidgets, container.model.get('widgetType'));
  }
  apply(args, container) {
    madxartworkPro.modules.woocommerce.onCreateWidget(container);
  }
}
...
class WoocommerceDeleteWidgetDeactivateSettingsModal extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-woocommerce-delete-widget-deactivate-settings-modal';
  }
  getContainerType() {
    return 'widget';
  }
  ...
  apply(args, container) {
    madxartworkPro.modules.woocommerce.onDeleteWidget(container);
  }
}
...
class WoocommerceNotices extends $e.modules.hookData.After {
  ...
  getConditions(args) {
    return 'kit' === madxartwork.documents.getCurrent().config.type && Array.isArray(args.settings.woocommerce_notices_elements);
  }
  apply(args) {
    const {
      woocommerce
...
class WoocommerceSaveShowModal extends $e.modules.hookData.After {
  ...
  getId() {
    return 'madxartwork-pro-woocommerce-save-show-modal';
  }
  getConditions(args) {
    return args.status && -1 !== ['private', 'publish'].indexOf(args.status);
  }
  apply() {
    madxartworkPro.modules.woocommerce.onUpdateDocument();
  }
}
...
class WoocommerceModule extends madxartworkModules.editor.utils.Module {
  constructor() {
    super(...arguments);
    this.pageSettingsWidgets = {
      'woocommerce-checkout-page': {
        headerMessage: __('Want to save this as your checkout page?', 'madxartwork-pro'),
        message: __('Changes you make here will override your existing WooCommerce settings.', 'madxartwork-pro'),
        confirmMessage: __('You\'ve updated your checkout page.', 'madxartwork-pro'),
        cancelMessage: __('<h3>Set up a checkout page</h3><br>Without a checkout page, visitors can\'t complete transactions on your site. To set one up, go to Site Settings.', 'madxartwork-pro'),
        failedMessage: __('<h3>Sorry, something went wrong.</h3><br>To define a checkout page for your site, head over to Site Settings.', 'madxartwork-pro'),
        optionName: 'woocommerce_checkout_page_id',
        woocommercePageName: 'checkout'
      },
      'woocommerce-cart': {
        headerMessage: __('Want to save this as your cart page?', 'madxartwork-pro'),
        message: __('Changes you make here will override your existing WooCommerce settings.', 'madxartwork-pro'),
        confirmMessage: __('You\'ve updated your cart page.', 'madxartwork-pro'),
        cancelMessage: __('<h3>Set up a cart page</h3><br>The cart page shows an order summary. To set one up, go to Site Settings.', 'madxartwork-pro'),
        failedMessage: __('<h3>Sorry, something went wrong.</h3><br>To define a cart page for your site, head over to Site Settings.', 'madxartwork-pro'),
        optionName: 'woocommerce_cart_page_id',
        woocommercePageName: 'cart'
      },
      'woocommerce-my-account': {
        headerMessage: __('Want to save this as your my account page?', 'madxartwork-pro'),
        message: __('Changes you make here will override your existing WooCommerce settings.', 'madxartwork-pro'),
        confirmMessage: __('You\'ve updated your my account page.', 'madxartwork-pro'),
        cancelMessage: __('<h3>Set up a My Account page</h3><br>Without it, customers can\'t update their billing details, review past orders, etc. To set up My Account, go to Site Settings.', 'madxartwork-pro'),
        failedMessage: __('<h3>Sorry, something went wrong.</h3><br>To define a my account page for your site, head over to Site Settings.', 'madxartwork-pro'),
        optionName: 'woocommerce_myaccount_page_id',
        woocommercePageName: 'myaccount'
      },
      'woocommerce-purchase-summary': {
        headerMessage: __('Want to save this as your purchase summary page?', 'madxartwork-pro'),
        message: __('Changes you make here will override your WooCommerce default purchase summary page.', 'madxartwork-pro'),
        confirmMessage: __('You\'ve updated your summary page.', 'madxartwork-pro'),
        cancelMessage: __('<h3>Set up a purchase summary page</h3><br>This page shows payment and order details. To set one up, go to Site Settings.', 'madxartwork-pro'),
        failedMessage: __('<h3>Sorry, something went wrong.</h3><br>To define a purchase summary page for your site, head over to Site Settings.', 'madxartwork-pro'),
        optionName: 'madxartwork_woocommerce_purchase_summary_page_id',
  ...
  onmadxartworkInit() {
    madxartwork.hooks.addAction('editor/widgets/loop-grid/on-init', this.addWooCommerceClassToLoopWrapper);
  }
  onmadxartworkFrontendInit() {
    madxartworkFrontend.elements.$body.on('added_to_cart', (e, data) => {
    ...
    if ('loop-item' === madxartwork.documents.currentDocument.config.type && 'product' === madxartwork.documents.currentDocument.config.settings.settings.source) {
      // Add the 'woocommerce' class to the Loop document wrapper only when editing a Product Loop Template in the
      // theme builder.
      madxartwork.on('document:loaded', () => {
        madxartwork.$previewContents[0].querySelector('.e-loop-item').classList.add('woocommerce');
      });
    }
  }
  ...
  onmadxartworkLoaded() {
    ...
    for (const section of noticeSections) {
      madxartwork.channels.editor.on('kit_settings:' + section + ':activated', () => {
        this.renderMockNotices(madxartwork.documents.getCurrent().container.settings.get('woocommerce_notices_elements'));
      });
    }

    // Custom Empty Cart Template.
    madxartwork.channels.editor.on('editor:widget:woocommerce-cart:section_additional_options:activated', () => {
      this.onTemplateIdChange('additional_template_select');
    });

    // Custom My Account Dashboard Template
    madxartwork.channels.editor.on('editor:widget:woocommerce-my-account:section_additional_options:activated', () => {
      this.onTemplateIdChange('customize_dashboard_select');
    });
  }
  renderMockNotices(noticeElements) {
    const noticesWrapper = madxartwork.$previewContents.find('.woocommerce-notices-wrapper');
    ...
    madxartworkFrontend.elements.$body.addClass(noticesClass.trim());
    noticesWrapper.addClass('madxartwork-loading');
    // Wait for the Ajax call to finish before the select2 can be changed again.
    jQuery('.madxartwork-select2').attr('disabled', 'disabled');
    madxartworkPro.ajax.addRequest('woocommerce_mock_notices', {
      data: {
        notice_elements: noticeElements
      },
      success(data) {
        noticesWrapper.remove();
        madxartwork.$previewContents.find('.madxartwork-editor-preview').prepend(data);
        noticesWrapper.removeClass('madxartwork-loading');
        // Enable the select2 again.
        jQuery('.madxartwork-select2').removeAttr('disabled');
      }
    });
  }
  onTemplateIdChange(sectionActive) {
    const editor = madxartwork.getPanelView().getCurrentPageView(),
      ...
      $editButton = editor.$el.find('.madxartwork-edit-template');
    if (!templateID) {
      $editButton.addClass('e-control-tool-disabled').hide();
    } else {
      const editUrl = madxartworkConfig.home_url + '?p=' + templateID + '&madxartwork';
  ...
  onUpdateDocument() {
    ...
    madxartworkFrontend.elements.$body.trigger('added_to_cart', [{
    ...
    const saveWoocommercePageSettingKeys = Object.keys(this.createdPageSettingsWidgets),
      ...
      postId = madxartwork.documents.getCurrent().id;
    ...
    if (postId === madxartworkPro.config.woocommerce.woocommercePages[lastWidgetCreatedOptions.woocommercePageName]) {
      return;
    }
    madxartworkCommon.dialogsManager.createWidget('confirm', {
      id: 'madxartwork-woocommerce-save-pages',
      ...
      strings: {
        ...
        cancel: __('No thanks', 'madxartwork-pro')
      },
  ...
  onConfirmModal(lastWidgetCreatedOptions) {
    madxartworkPro.ajax.addRequest('woocommerce_update_page_option', {
      data: {
  ...
  showPagesSettingsToast(message) {
    const buttons = [];
    madxartwork.notifications.initToast();
    buttons.push({
      name: 'take_me_there',
      text: __('Take me there', 'madxartwork'),
  ...
  openSiteSettingsTab() {
    ...
    const isWPPreviewMode = madxartworkCommon.elements.$body.hasClass('madxartwork-editor-preview');
    if (isWPPreviewMode) {
      madxartwork.exitPreviewMode();
    }
    const isInSettingsPanelActive = 'panel/global/menu' === madxartwork.documents.currentDocument.config.panel.default_route;
    if (isInSettingsPanelActive) {
      $e.run('panel/global/close');
      return;
    }
    $e.run('editor/documents/switch', {
      id: madxartwork.config.kit_id,
      mode: 'autosave'
    }).then(() => {
      if (tabId) {
    ...
    .then(() => {
      if (sectionId) {
        const sectionElement = jQuery('.madxartwork-control-' + sectionId);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "madxartwork-pro:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || [];
...
var madxartworkPro = Marionette.Application.extend({
  ...
  initModules() {
    ...
    if (madxartworkCommon.config.experimentalFeatures['page-transitions']) {
    ...
    if (madxartworkCommon.config.experimentalFeatures['mega-menu']) {
      madxartworkCommon.elements.$window.on('madxartwork/nested-element-type-loaded', async () => {
  ...
  onStart() {
    ...
    this.initModules();
    jQuery(window).on('madxartwork:init', () => this.onmadxartworkInit()).on('madxartwork/connect/success/editor-pro-activate', this.onActivateSuccess);
  },
  onmadxartworkInit() {
    madxartwork.on('preview:loaded', () => this.onmadxartworkPreviewLoaded());
    madxartworkPro.libraryRemoveGetProButtons();
    madxartworkCommon.debug.addURLToWatch('madxartwork-pro/assets');
  },
  onmadxartworkPreviewLoaded() {
    madxartwork.$preview[0].contentWindow.madxartworkPro = this;
  },
  libraryRemoveGetProButtons() {
    madxartwork.hooks.addFilter('madxartwork/editor/template-library/template/action-button', function (viewID, templateData) {
      var _madxartwork$config, _madxartwork$config$lib;
      if (templateData.accessLevel === undefined || ((_madxartwork$config = madxartwork.config) === null || _madxartwork$config === void 0 ? void 0 : (_madxartwork$config$lib = _madxartwork$config.library_connect) === null || _madxartwork$config$lib === void 0 ? void 0 : _madxartwork$config$lib.current_access_level) === undefined) {
        // BC support.
      ...
      if (templateData.accessLevel > 0 && !madxartworkPro.config.isActive) {
        return '#tmpl-madxartwork-pro-template-library-activate-license-button';
      }
      ...
      if (templateData.accessLevel > madxartwork.config.library_connect.current_access_level) {
        return viewID;
      }

      // When the current license can insert the template.
      return '#tmpl-madxartwork-template-library-insert-button';
    });
  },
  onActivateSuccess() {
    // Hide notice.
    madxartwork.noticeBar.onCloseClick();

    // Mark site connect for insert templates connect screen.
    madxartwork.config.library_connect.is_connected = true;

    // Mark pro is active - for `this.libraryRemoveGetProButtons`.
    madxartworkPro.config.isActive = true;
    madxartwork.notifications.showToast({
      message: __('Connected Successfully', 'madxartwork')
    });
  }
});
