...
/**
 * This file load madxartwork core in order to run 'editor' tests, since the 'pro' does not include the editor it self.
...
// import EditorBootstrapCore from 'madxartwork/tests/qunit/editor/bootstrap';
...
// 	initialize() {
// 		window.madxartworkProEditorConfig = editorConfig;
// 
// 		// Load madxartwork-pro.
