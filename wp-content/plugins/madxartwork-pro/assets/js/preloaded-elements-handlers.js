...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["preloaded-elements-handlers"],{
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('animated-headline', _animatedHeadlines.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('media-carousel', _mediaCarousel.default);
    madxartworkFrontend.elementsHandler.attachHandler('testimonial-carousel', _testimonialCarousel.default);
    madxartworkFrontend.elementsHandler.attachHandler('reviews', _testimonialCarousel.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('countdown', _countdown.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    madxartworkFrontend.elementsHandler.attachHandler('form', [...formHandlers, _recaptcha.default, _date.default, _time.default]);
    madxartworkFrontend.elementsHandler.attachHandler('subscribe', formHandlers);
  }
}
exports["default"] = _default;
...
class FormSteps extends madxartworkModules.frontend.handlers.Base {
  ...
  getSubmitButton() {
    ...
    // TODO: When a solution for the conditions will be found, check if can remove the madxartwork-col-x manipulation.
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('gallery', _handler.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('hotspot', _hotspot.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    ['post', 'product'].forEach(skinName => {
      madxartworkFrontend.elementsHandler.attachHandler('loop-grid', _loadMore.default, skinName);
      madxartworkFrontend.elementsHandler.attachHandler('loop-grid', _loop.default, skinName);
      madxartworkFrontend.elementsHandler.attachHandler('loop-carousel', _loop.default, skinName);
      madxartworkFrontend.elementsHandler.attachHandler('loop-carousel', _loopCarousel.default, skinName);
    });
  }
}
exports["default"] = _default;
...
class LoopLoadMore extends _loadMore.default {
  ...
  afterInsertPosts(postsElements, result) {
    ...
    if (madxartworkFrontend.config.experimentalFeatures.e_lazyload) {
...
exports["default"] = void 0;
var _imageCarousel = _interopRequireDefault(__webpack_require__(/*! madxartwork/assets/dev/js/frontend/handlers/image-carousel */ "../../madxartwork/assets/dev/js/frontend/handlers/image-carousel.js"));
var _elementHandlers = _interopRequireDefault(__webpack_require__(/*! ./utils/element-handlers */ "../modules/loop-builder/assets/js/frontend/handlers/utils/element-handlers.js"));
class LoopCarousel extends _imageCarousel.default {
  getDefaultSettings() {
    const defaultSettings = super.getDefaultSettings();
    defaultSettings.selectors.carousel = '.madxartwork-loop-container';
    return defaultSettings;
  }
  getSwiperSettings() {
...
class Loop extends _posts.default {
  ...
  getDefaultSettings() {
    ...
    defaultSettings.selectors.postsContainer = '.madxartwork-loop-container';
    defaultSettings.classes.inPlaceTemplateEditable = 'madxartwork-in-place-template-editable';
    return defaultSettings;
  }
  ...
  getVerticalSpaceBetween() {
    return madxartworkProFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), 'row_gap', 'size');
  }
  ...
  handleSwiper() {
    ...
    swiper.update();
    this.elementsToRemove = [...this.elementsToRemove, '.swiper-pagination', '.madxartwork-swiper-button', '.madxartwork-document-handle'];
  }
  attachEditDocumentHandle() {
    // eslint-disable-next-line computed-property-spacing
    const id = this.getElementSettings('template_id'),
      elementData = madxartwork.getElementData(madxartworkFrontend.config.elements.data[this.getModelCID()]),
    ...
    if (this.isFirstEdit()) {
      ...
      this.$element.find('.madxartwork-swiper-button').remove();
      return;
    }
    (0, _documentHandle.default)({
      ...
      title: __('Template', 'madxartwork-pro'),
      id
    }, _documentHandle.EDIT_CONTEXT, () => this.onInPlaceEditTemplate(), '.madxartwork-element-' + this.getID() + ' .madxartwork-' + id);
  }
  isFirstEdit() {
  ...
  handleCTA() {
    ...
    shadowRoot.appendChild(madxartworkPro.modules.loopBuilder.getCtaContent(this.getWidgetType()));
...
function runElementHandlers(elements) {
  [...elements].flatMap(el => [...el.querySelectorAll('.madxartwork-element')]).forEach(el => madxartworkFrontend.elementsHandler.runReadyTrigger(el));
}
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('lottie', _handler.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('mega-menu', _megaMenu.default);
  }
}
exports["default"] = _default;
...
exports["default"] = void 0;
class MegaMenu extends madxartworkModules.frontend.handlers.NestedTabs {
  getDefaultSettings() {
  ...
  isNeedToOpenOnClick() {
    ...
    return this.isEdit || nonMobileDevices.includes(madxartworkFrontend.getCurrentDeviceMode()) || this.getElementSettings('open_on') !== 'hover';
  }
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    madxartworkFrontend.elementsHandler.attachHandler('nav-menu', _navMenu.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    madxartworkFrontend.elementsHandler.attachHandler('form', _formsAction.default);
  ...
  onFrontendComponentsInit() {
    madxartworkFrontend.utils.urlActions.addAction('popup:open', settings => this.showPopup(settings));
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    ['classic', 'full_content', 'cards'].forEach(skinName => {
      madxartworkFrontend.elementsHandler.attachHandler('posts', _loadMore.default, skinName);
    });
    madxartworkFrontend.elementsHandler.attachHandler('posts', _posts.default, 'classic');
    madxartworkFrontend.elementsHandler.attachHandler('posts', _posts.default, 'full_content');
    madxartworkFrontend.elementsHandler.attachHandler('posts', _cards.default, 'cards');
    madxartworkFrontend.elementsHandler.attachHandler('portfolio', _portfolio.default);
  }
}
exports["default"] = _default;
...
class LoadMore extends madxartworkModules.frontend.handlers.Base {
  ...
  onInit() {
    ...
    this.postId = madxartworkFrontendConfig.post.id;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('share-buttons', _shareButtons.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('slides', _slides.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('facebook-button', _facebook.default);
    madxartworkFrontend.elementsHandler.attachHandler('facebook-comments', _facebook.default);
    madxartworkFrontend.elementsHandler.attachHandler('facebook-embed', _facebook.default);
    madxartworkFrontend.elementsHandler.attachHandler('facebook-page', _facebook.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('table-of-contents', _tableOfContents.default);
  }
}
exports["default"] = _default;
...
class TOCHandler extends madxartworkModules.frontend.handlers.Base {
  ...
  getContainer() {
    ...
    const $documentWrapper = this.$element.parents('.madxartwork');
...
class _default extends madxartworkModules.Module {
  constructor() {
    ...
    ['archive_classic', 'archive_full_content', 'archive_cards'].forEach(skinName => {
      madxartworkFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsLoadMore.default, skinName);
    });
    madxartworkFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinClassic.default, 'archive_classic');
    madxartworkFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinClassic.default, 'archive_full_content');
    madxartworkFrontend.elementsHandler.attachHandler('archive-posts', _archivePostsSkinCards.default, 'archive_cards');
    jQuery(function () {
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('search-form', _searchForm.default);
  }
}
exports["default"] = _default;
...
class _default extends madxartworkModules.Module {
  constructor() {
    super();
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-menu-cart', _menuCart.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-purchase-summary', _purchaseSummary.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-checkout-page', _checkoutPage.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-cart', _cart.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-my-account', _myAccount.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-notices', _notices.default);
    madxartworkFrontend.elementsHandler.attachHandler('woocommerce-product-add-to-cart', _productAddToCart.default);
...
class _default extends madxartworkModules.frontend.handlers.Base {
  ...
  bindEvents() {
    ...
    madxartworkFrontend.elements.$body.on('wc_fragments_refreshed removed_from_cart added_to_cart', (event, data) => this.refreshFragments(event.type, data));
...
/***/ "../../madxartwork/assets/dev/js/frontend/handlers/image-carousel.js":
/*!*************************************************************************!*\
  !*** ../../madxartwork/assets/dev/js/frontend/handlers/image-carousel.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = void 0;
class ImageCarousel extends madxartworkModules.frontend.handlers.SwiperBase {
  getDefaultSettings() {
    return {
      selectors: {
  ...
  getSwiperSettings() {
    const elementSettings = this.getElementSettings(),
      ...
      madxartworkBreakpoints = madxartworkFrontend.config.responsive.activeBreakpoints,
    ...
    Object.keys(madxartworkBreakpoints).reverse().forEach(breakpointName => {
      ...
      swiperOptions.breakpoints[madxartworkBreakpoints[breakpointName].value] = {
        slidesPerView: +elementSettings['slides_to_show_' + breakpointName] || defaultSlidesToShow,
        slidesPerGroup: +elementSettings['slides_to_scroll_' + breakpointName] || 1
      };
      if (elementSettings.image_spacing_custom) {
        swiperOptions.breakpoints[madxartworkBreakpoints[breakpointName].value].spaceBetween = this.getSpaceBetween(breakpointName);
      }
  ...
  getSpaceBetween() {
    ...
    return madxartworkFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), 'image_spacing_custom', 'size', device) || 0;
  }
  updateSpaceBetween(propertyName) {
    const deviceMatch = propertyName.match('image_spacing_custom_(.*)'),
      ...
      newSpaceBetween = this.getSpaceBetween(device);
    if ('desktop' !== device) {
      this.swiper.params.breakpoints[madxartworkFrontend.config.responsive.activeBreakpoints[device].value].spaceBetween = newSpaceBetween;
    }
    this.swiper.params.spaceBetween = newSpaceBetween;
    this.swiper.update();
  }
