...
var EComponent = /*#__PURE__*/function (_$e$modules$Component) {
  ...
  function EComponent(args) {
    ...
    window.addEventListener('message', function (event) {
      if (event.data.name !== 'madxartwork-pro/notes/config') {
        return;
      }
    ...
    window.addEventListener('DOMContentLoaded', function () {
      var adminBarButton = document.getElementById('wp-admin-bar-madxartwork_notes');
      if (!adminBarButton) {
        return;
      }
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(EComponent, [{
    ...
    value: function open() {
      ...
      this.getPreviewFrame().postMessage({
        name: 'madxartwork-pro/notes/open'
      }, '*');
      return true;
    }
    ...
    value: function close() {
      ...
      this.getPreviewFrame().postMessage({
        name: 'madxartwork-pro/notes/close'
      }, '*');
      return true;
    }
    ...
    value: function updateEditorState(mode) {
      ...
      switch (mode) {
        case this.constructor.NOTES_MODE_OPEN:
          madxartwork.getPanelView().modeSwitcher.currentView.setMode('preview');
          madxartwork.channels.dataEditMode.once('switch', function () {
            if (!_this2.isOpen) {
              return;
            }
            window.top.$e.run('notes/close');
        ...
        case this.constructor.NOTES_MODE_CLOSE:
          madxartwork.getPanelView().modeSwitcher.currentView.setMode('editor');
          break;
        default:
    ...
    value: function getPreviewFrame() {
      return this.isInEditor() ? madxartwork.$preview[0].contentWindow : window;
    }
  }, {
    ...
    value: function contextMenuNotesGroup() {
      ...
      elTypes.forEach(function (type) {
        madxartwork.hooks.addFilter("elements/".concat(type, "/contextMenuGroups"), _this3.contextMenuAddGroup);
      });
    }
    ...
    value: function contextMenuAddGroup(groups) {
      var notesGroup = _.findWhere(groups, {
        ...
        notesActionItem = {
          name: 'open_notes',
          title: __('Notes', 'madxartwork-pro'),
          shortcut: '⇧+C',
