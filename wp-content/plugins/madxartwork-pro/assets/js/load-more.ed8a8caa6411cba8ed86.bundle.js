...
class LoadMore extends madxartworkModules.frontend.handlers.Base {
  ...
  handleSuccessFetch(result) {
    ...
    const posts = html.querySelectorAll('.madxartwork-posts-container > article'); // Converting HTMLCollection to an Array and iterate it.
  ...
  handlePostsQuery() {
    ...
    this.currentPage++;
    const restUrl = `${madxartworkProFrontendConfig.urls.rest}madxartwork-pro/v1/posts-widget?post_id=${this.postId}&element_id=${this.elementId}&page=${this.currentPage}`;
