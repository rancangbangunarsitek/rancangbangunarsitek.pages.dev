...
function useFeatureLock(featureName) {
  ...
  const appConfig = madxartworkAppProConfig[featureName] ?? {},
...
class ConditionsProvider extends _baseContext.default {
  ...
  fetchSubIdsTitles(condition) {
    return new Promise(resolve => {
      return madxartworkCommon.ajax.loadObjects({
        ...
        data: {
          ...
          unique_id: madxartworkCommon.helpers.getUniqueId()
        },
        success(response) {
          resolve(response);
        }
  ...
  render() {
    if (this.state.action.current === ConditionsProvider.actions.FETCH_CONFIG) {
      if (this.state.error) {
        return /*#__PURE__*/_react.default.createElement("h3", null, __('Error:', 'madxartwork-pro'), " ", this.state.error);
      }
      if (this.state.loading) {
        return /*#__PURE__*/_react.default.createElement("h3", null, __('Loading', 'madxartwork-pro'), "...");
      }
    }
...
exports["default"] = void 0;
class Condition {
  id = madxartworkCommon.helpers.getUniqueId();
  default = '';
  type = 'include';
  name = '';
  sub = '';
...
class ConditionsConfig {
  ...
  calculateInstances(conditions) {
    ...
    if (0 === Object.keys(instances).length) {
      instances = [__('No instances', 'madxartwork-pro')];
    }
    return instances;
  }
}
  ...
  render() {
    if (this.state.action.current === TemplatesProvider.actions.FETCH) {
      if (this.state.action.error) {
        return /*#__PURE__*/_react.default.createElement("h3", null, __('Error:', 'madxartwork-pro'), " ", this.state.action.error);
      }
...
const SiteTemplateFooter = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.CardFooter, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    tag: "span",
    variant: "sm"
  }, /*#__PURE__*/_react.default.createElement("b", null, __('Instances', 'madxartwork-pro'), ":")), /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    className: "e-site-template__instances-list",
    tag: "span",
    variant: "xxs"
  }, " ", instances), /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    text: __('Edit Conditions', 'madxartwork-pro'),
...
function SiteTemplateThumbnail(props) {
  return /*#__PURE__*/_react.default.createElement(_appUi.CardImage, {
    ...
    text: __('Preview', 'madxartwork-pro'),
...
function SiteTemplates(props) {
  ...
  if (!templates || !templates.length) {
    return /*#__PURE__*/_react.default.createElement("h3", null, __('No Templates found. Want to create one?', 'madxartwork-pro'), "...");
  }
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    approveButtonUrl: "https://go.madxartwork.com/app-theme-builder-template-load-issue",
...
var _useFeatureLock = _interopRequireDefault(__webpack_require__(/*! madxartwork-pro-app/hooks/use-feature-lock */ "../core/app/assets/js/hooks/use-feature-lock.js"));
function AddNew() {
  const {
      templates
    } = _react.default.useContext(_templates.Context),
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    variant: "h1"
  }, __('Start customizing every part of your site', 'madxartwork-pro')), isLocked && /*#__PURE__*/_react.default.createElement(ConnectButton, null))), /*#__PURE__*/_react.default.createElement(_siteEditor.SiteParts, {
...
function ConditionConflicts(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    ...
    variant: "sm"
  }, __('madxartwork recognized that you have set this location for other templates: ', 'madxartwork-pro'), " ", conflictLinks);
}
...
function getSettings(autocomplete) {
  return {
    allowClear: false,
    placeholder: __('All', 'madxartwork-pro'),
    dir: madxartworkCommon.config.isRTL ? 'rtl' : 'ltr',
    ajax: {
      transport(params, success, failure) {
        return madxartworkCommon.ajax.addRequest('pro_panel_posts_control_filter_autocomplete', {
          data: {
            q: params.data.q,
            autocomplete
          },
...
function ConditionsRows(props) {
  ...
  const rows = Object.values(conditions).map(condition => /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: __('Delete', 'madxartwork-pro'),
    icon: "eicon-close",
    hideText: true,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, action.error && /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    approveButtonText: __('Learn More', 'madxartwork-pro'),
    approveButtonColor: "link",
    approveButtonUrl: "https://go.madxartwork.com/app-theme-builder-conditions-load-issue",
    approveButtonTarget: "_target"
  }), /*#__PURE__*/_react.default.createElement("div", {
    ...
    variant: "contained",
    size: "lg",
    text: __('Add Condition', 'madxartwork-pro'),
    onClick: create
  })), /*#__PURE__*/_react.default.createElement("div", {
...
function Conditions(props) {
  ...
  if (!template) {
    return /*#__PURE__*/_react.default.createElement("div", null, __('Not Found', 'madxartwork-pro'));
  }
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    variant: "h1",
    tag: "h1"
  }, __('Where Do You Want to Display Your Template?', 'madxartwork-pro')), /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    variant: "p"
  }, __('Set the conditions that determine where your template is used throughout your site.', 'madxartwork-pro'), /*#__PURE__*/_react.default.createElement("br", null), __('For example, choose \'Entire Site\' to display the template across your site.', 'madxartwork-pro'))), /*#__PURE__*/_react.default.createElement(_conditions.default, {
...
function Templates() {
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    alignItems: "start",
    className: "page-header"
  }, /*#__PURE__*/_react.default.createElement("h1", null, __('Your Site\'s Global Parts', 'madxartwork-pro')), isLocked ? /*#__PURE__*/_react.default.createElement(ConnectButton, null) : /*#__PURE__*/_react.default.createElement(_appUi.AddNewButton, {
...
function DialogRename(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    title: __('Rename Site Part', 'madxartwork-pro'),
    approveButtonText: __('Change', 'madxartwork-pro'),
    onSubmit: () => closeDialog(true),
    approveButtonOnClick: () => closeDialog(true),
...
function PartActionsButtons(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: __('Toggle', 'madxartwork-pro'),
    hideText: true,
...
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function SiteEditor() {
  var _madxartworkAppProConfi, _madxartworkAppProConfi2;
  const {
    isLocked
  } = (0, _useFeatureLock.default)('site-editor');
  ...
  // Remove Core cache.
  madxartworkCommon.ajax.invalidateCache({
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.ErrorBoundary, {
    title: __('Theme Builder could not be loaded', 'madxartwork-pro'),
    learnMoreUrl: "https://go.madxartwork.com/app-theme-builder-load-issue"
    ...
    text: __('Switch to table view', 'madxartwork-pro'),
    url: (_madxartworkAppProConfi = madxartworkAppProConfig['site-editor']) === null || _madxartworkAppProConfi === void 0 ? void 0 : (_madxartworkAppProConfi2 = _madxartworkAppProConfi.urls) === null || _madxartworkAppProConfi2 === void 0 ? void 0 : _madxartworkAppProConfi2.legacy_view
  })))));
}
class Module {
  constructor() {
