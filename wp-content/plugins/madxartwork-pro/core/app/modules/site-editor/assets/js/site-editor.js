...
import { Layout, AllPartsButton, NotFound } from '@madxartwork/site-editor';
import { ErrorBoundary, Grid, Button } from '@madxartwork/app-ui';
				...
				<Grid container className="e-site-editor__content_container">
					...
					<Grid item className="e-site-editor__content_container_secondary">
						<Button
							...
							url={ madxartworkAppProConfig[ 'site-editor' ]?.urls?.legacy_view }
						/>
					</Grid>
				</Grid>
			</Layout>
