    ...
    var WidgetElementsPostsDCEHandler = function ($scope, $) {
        ...
        if ($objBlock_acfposts.data('style') == 'grid') {
            ...
            var swiperOptions = {
                ...
                loop: cicloInfinito,
                navigation: {
                    nextEl: id_post ? '.dce-madxartwork-post-' + id_post + ' .madxartwork-element-' + id_scope + ' .next-' + id_scope : '.next-' + id_scope,
                    prevEl: id_post ? '.dce-madxartwork-post-' + id_post + ' .madxartwork-element-' + id_scope + ' .prev-' + id_scope : '.prev-' + id_scope,
                },
                pagination: {
                    ...
                    $objBlock_acfposts.on( 'append.infiniteScroll', function( event, response, path, items ) {
						...
						if ( madxartworkFrontend) {
							if ( madxartworkFrontend.elementsHandler.runReadyTrigger ) {
								var widgets = $('.madxartwork-widget-dce-dyncontel-acfposts').find('.madxartwork-widget');
						...
						var allArticles = document.querySelectorAll(".madxartwork-widget-dce-dyncontel-acfposts .madxartwork-section, .madxartwork-widget-dce-dyncontel-acfposts .madxartwork-column");
