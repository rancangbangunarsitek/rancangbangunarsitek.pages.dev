...
function handleAnimsition(newValue){$('body').toggleClass('dce-smoothtransition');if(newValue){if(!is_animsition){settings_global=madxartwork.settings.dynamicooo.model.attributes}
...
function handleHeaderTracker(newValue){settings_global=madxartwork.settings.dynamicooo.model.attributes;if(newValue){if(!$('body.dce-trackerheader').length)
...
$(window).on('madxartwork/frontend/init',function(){if(madxartworkFrontend.isEditMode()){if(madxartwork.settings.dynamicooo){madxartwork.settings.dynamicooo.addChangeCallback('enable_smoothtransition',handleAnimsition);madxartwork.settings.dynamicooo.addChangeCallback('dce_smoothtransition_class_controller',handleAnimsition);madxartwork.settings.dynamicooo.addChangeCallback('smoothtransition_enable_overlay',handleOverlay);madxartwork.settings.dynamicooo.addChangeCallback('smoothtransition_loading_mode',handleLoadingMode);madxartwork.settings.dynamicooo.addChangeCallback('smoothtransition_loading_style',handleLoadingStyle);madxartwork.settings.dynamicooo.addChangeCallback('enable_trackerheader',handleHeaderTracker);madxartwork.settings.dynamicooo.addChangeCallback('dce_trackerheader_class_controller',handleHeaderTracker);madxartwork.settings.dynamicooo.addChangeCallback('trackerheader_overlay',handleTrackerHeader_Overlay)}}});$(function(){if(typeof madxartworkFrontendConfig!=="undefined"){settings_global=madxartworkFrontendConfig.settings.dynamicooo}else{settings_global=dceGlobalSettings}
if(settings_global){var responsive_smoothtransition=settings_global.responsive_smoothtransition||['desktop','tablet','mobile'];var enableSmoothtransition=settings_global.enable_smoothtransition||'';var smoothtransitionClassController=settings_global.dce_smoothtransition_class_controller||'';var responsive_trackerheader=settings_global.responsive_trackerheader||['desktop','tablet','mobile'];var enableTrackerHeader=settings_global.enable_trackerheader||'';var trackerheaderClassController=settings_global.dce_trackerheader_class_controller||'';var deviceMode=$('body').attr('data-madxartwork-device-mode')||'desktop';if(enableSmoothtransition&&$.inArray(deviceMode,responsive_smoothtransition)>=0&&smoothtransitionClassController)
