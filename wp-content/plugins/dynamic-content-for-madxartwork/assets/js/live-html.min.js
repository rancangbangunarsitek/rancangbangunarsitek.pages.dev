...
function initializeAllLiveHtmlFields($scope){$scope.find('.madxartwork-field-type-dce_live_html').each((_,w)=>initializeLiveHtml(w,$scope[0]))}
jQuery(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/form.default',initializeAllLiveHtmlFields)})