...
if($scope.find('.swiper-slide').length>1){if('undefined'===typeof Swiper){const asyncSwiper=madxartworkFrontend.utils.swiper;new asyncSwiper(elementSwiper,swiperOptions).then((newSwiperInstance)=>{dce_swiper=newSwiperInstance})}else{dce_swiper=new Swiper(elementSwiper,swiperOptions)}
