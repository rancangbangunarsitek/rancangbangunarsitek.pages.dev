...
var responsivePoints=dceSwiperOptions.breakpoints={};responsivePoints[madxartworkBreakpoints.lg]={slidesPerView:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView'])||'auto',slidesPerGroup:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween'])||0,slidesPerColumn:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween'])||0,slidesOffsetBefore:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetBefore'])||0,slidesOffsetAfter:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetAfter'])||0,};responsivePoints[madxartworkBreakpoints.md]={slidesPerView:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView'])||'auto',slidesPerGroup:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween'])||0,slidesPerColumn:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween_tablet'])||0,slidesOffsetBefore:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetBefore_tablet'])||0,slidesOffsetAfter:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetAfter_tablet'])||0,};responsivePoints[madxartworkBreakpoints.xs]={slidesPerView:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView_mobile'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerView'])||'auto',slidesPerGroup:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup_mobile'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesPerGroup'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween_mobile'])||Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween'])||0,slidesPerColumn:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn_mobile'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn_tablet'])||Number(elementSettings[DCE_dynposts_skinPrefix+'slidesColumn'])||1,spaceBetween:Number(elementSettings[DCE_dynposts_skinPrefix+'spaceBetween_mobile'])||0,slidesOffsetBefore:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetBefore_mobile'])||0,slidesOffsetAfter:Number(elementSettings[DCE_dynposts_skinPrefix+'slidesOffsetAfter_mobile'])||0,};dceSwiperOptions=$.extend(dceSwiperOptions,responsivePoints);function initSwiperCarousel(){if(smsc){smsc.remove()}
if(dcePostsSwiper){dcePostsSwiper.destroy()}
if('undefined'===typeof Swiper){const asyncSwiper=madxartworkFrontend.utils.swiper;new asyncSwiper(elementSwiper[0],dceSwiperOptions).then((newSwiperInstance)=>{dcePostsSwiper=newSwiperInstance})}else{dcePostsSwiper=new Swiper(elementSwiper[0],dceSwiperOptions)}}
if(elementSwiper.length){initSwiperCarousel()}
var Dyncontel_MutationObserverCallback=function(mutationsList,observer){for(var mutation of mutationsList){if(mutation.type=='attributes'&&mutation.attributeName==='class'&&isCarouselEnabled){dcePostsSwiper.update()}}};observe_Dyncontel_element($scope[0],Dyncontel_MutationObserverCallback)};jQuery(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-woo-products-cart.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-woo-products.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-woo-product-upsells.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-woo-product-crosssells.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-my-posts.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-sticky-posts.carousel',Widget_DCE_Dynamicposts_carousel_Handler);madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-search-results.carousel',Widget_DCE_Dynamicposts_carousel_Handler)})