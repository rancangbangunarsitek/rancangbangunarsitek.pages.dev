...
const scene=new Scene()};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-bgcanvas.default',WidgetElements_BGCanvasHandler)})})(jQuery)