	...
	if (elementSettings.infiniteScroll_enable){
		...
		if( 'template' === elementSettings.style_items ) {
			grid_container.on( 'append.infiniteScroll', function( event, title, path ) {
				...
				var allArticles = document.querySelectorAll(".dce-dynamic-posts-collection .madxartwork-section, .dce-dynamic-posts-collection .madxartwork-column");
...
jQuery(window).on('madxartwork/frontend/init', function () {
	...
	madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.grid', Widget_DCE_Dynamicposts_grid_Handler);
    madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-show-favorites.grid-filters', Widget_DCE_Dynamicposts_grid_Handler);
