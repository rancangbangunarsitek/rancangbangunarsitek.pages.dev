var Widget_DCE_Dynamicposts_nextpost_Handler = function ($scope, $) {
    ...
    $scope.removeClass('madxartwork-widget-empty');
      ...
      if(use_template){
          jQuery.ajax({
                ...
                success: function (data, status, xhr) {
                    ...
                    var element_el = $result.find('.madxartwork-element');
...
jQuery(window).on('madxartwork/frontend/init', function () {
    ...
    madxartworkFrontend.hooks.addAction('frontend/element_ready/dce-dynamicposts-v2.nextpost', Widget_DCE_Dynamicposts_nextpost_Handler);
