...
$('#dce-svg-'+id_scope).attr('data-morphid',step)};var waypointOptions={offset:'100%',triggerOnce:!1};madxartworkFrontend.waypoint($($el),runAnim,waypointOptions)}};var mouseenterFn=function(){step=1;$('#dce-svg-'+id_scope).attr('data-morphid',step);if(!is_running)
