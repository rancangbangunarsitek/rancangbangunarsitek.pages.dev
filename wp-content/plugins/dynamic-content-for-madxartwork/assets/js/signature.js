function initializeSignaturePad(wrapper, $scope, $) {
    ...
    $button = $scope.find('.madxartwork-field-type-submit button');
...
jQuery(window).on('madxartwork/frontend/init', function() {
    madxartworkFrontend.hooks.addAction('frontend/element_ready/form.default', WidgetElements_FormSignature);
});
