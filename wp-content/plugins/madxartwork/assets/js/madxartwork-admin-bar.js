...
/* global madxartworkAdminBarConfig */
var AdminBar = /*#__PURE__*/function (_madxartworkModules$Vie) {
  (0, _inherits2.default)(AdminBar, _madxartworkModules$Vie);
  ...
  (0, _createClass2.default)(AdminBar, [{
    ...
    function getDefaultSettings() {
      return {
        ...
        classes: {
          ...
          adminBarItemTitle: 'madxartwork-edit-link-title',
          adminBarItemSubTitle: 'madxartwork-edit-link-type',
    ...
    value: function onInit() {
      ...
      this.createMenu(madxartworkAdminBarConfig);
    }
    ...
    value: function createMenuItem(item) {
      ...
      return jQuery('<li>', {
        id: id,
        class: children.length ? 'menupop' : '' + (item.parent_class || 'madxartwork-general-section')
...
/******/ })()
;
//# sourceMappingURL=madxartwork-admin-bar.js.map