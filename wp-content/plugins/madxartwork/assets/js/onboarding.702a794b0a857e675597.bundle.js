...
"use strict";
(self["webpackChunkmadxartwork"] = self["webpackChunkmadxartwork"] || []).push([["onboarding"],{
...
function GoProPopover(props) {
  ...
  var alreadyHaveProButtonRef = (0, _react.useCallback)(function (alreadyHaveProButton) {
    ...
    alreadyHaveProButton.addEventListener('click', function (event) {
      ...
      window.open(alreadyHaveProButton.href + '&mode=popup', 'madxartworkUploadPro', "toolbar=no, menubar=no, width=728, height=531, top=100, left=100");

      // Run the callback for when the upload succeeds.
      madxartworkCommon.elements.$body.on('madxartwork/upload-and-install-pro/success', function () {
        updateState({
          hasPro: true,
          proNotice: {
            type: 'success',
            icon: 'eicon-check-circle-o',
            message: __('madxartwork Pro has been successfully installed.', 'madxartwork')
          }
        });
      });
    });
  ...
  var goProButton = props.buttonsConfig.find(function (button) {
    ...
    getElProButton = {
      ...
      target: '_blank',
      href: 'https://madxartwork.com/pro/?utm_source=onboarding-wizard&utm_campaign=gopro&utm_medium=wp-dash&utm_content=top-bar-dropdown&utm_term=' + madxartworkAppConfig.onboarding.onboardingVersion,
      tabIndex: 0,
      onClick: function onClick() {
        madxartworkCommon.events.dispatchEvent({
          event: 'get madxartwork pro',
          version: '',
          details: {
            placement: madxartworkAppConfig.onboarding.eventPlacement,
            step: state.currentStep
  ...
  return /*#__PURE__*/_react.default.createElement(_popoverDialog.default, {
  ...
  }, __('Ready to Get madxartwork Pro?', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_checklist.default, null, /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('90+ Basic & Pro widgets', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('300+ Basic & Pro templates', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_checklistItem.default, null, __('Premium Support', 'madxartwork'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__go-pro-paragraph"
  }, __('And so much more!', 'madxartwork')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__go-pro-paragraph"
    ...
    href: madxartworkAppConfig.onboarding.urls.uploadPro,
    rel: "opener"
  }, __('Already have madxartwork Pro?', 'madxartwork')))));
}
...
var _headerButtons = _interopRequireDefault(__webpack_require__(/*! madxartwork-app/layout/header-buttons */ "../app/assets/js/layout/header-buttons.js"));
...
function ContextProvider(props) {
  var onboardingConfig = madxartworkAppConfig.onboarding,
    initialState = {
...
function Account() {
  ...
  if (state.isLibraryConnected) {
    pageTexts = {
      ...
      listItems: [__('Set your site\'s theme', 'madxartwork'), __('Give your site a name & logo', 'madxartwork'), __('Choose how to start creating', 'madxartwork')]
    };
  } else {
    pageTexts = {
      firstLine: __('To get the most out of madxartwork, we’ll connect your account.', 'madxartwork') + ' ' + __('Then you can:', 'madxartwork'),
      listItems: [__('Choose from countless professional templates', 'madxartwork'), __('Manage your site with our handy dashboard', 'madxartwork'), __('Take part in the community forum, share & grow together', 'madxartwork')]
    };
  }
  ...
  }, /*#__PURE__*/_react.default.createElement("p", null, __('Already have one?', 'madxartwork') + ' ', /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, __('Connect your account', 'madxartwork'))), /*#__PURE__*/_react.default.createElement(_connect.default, {
...
function GoodToGo() {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    className: "e-onboarding__page-content-section-title"
  }, __('That\'s a wrap! What\'s next?', 'madxartwork')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__page-content-section-text"
  }, __('There are two ways to get started with madxartwork:', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_grid.default, {
    container: true,
    alignItems: "center",
    justify: "space-between",
...
function HelloTheme() {
  ...
  var activateHelloTheme = function activateHelloTheme() {
    ...
    setActivateHelloThemeAjaxState({
      data: {
        action: 'madxartwork_activate_hello_theme'
      }
    });
  };
  ...
  (0, _react.useEffect)(function () {
    ...
    var timeout4 = setTimeout(function () {
      ...
      }, __('Hold on, this can take a minute...', 'madxartwork'))));
    }, 4000);
    ...
    var timeout30 = setTimeout(function () {
      ...
      setActionButtonText( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("i", {
        ...
        className: "e-onboarding__action-button-text"
      }, __('Okay, now we\'re really close...', 'madxartwork'))));
    }, 30000);
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("p", null, __('Hello is madxartwork\'s official blank canvas theme optimized to build your website exactly the way you want.', 'madxartwork')), /*#__PURE__*/_react.default.createElement("p", null, __('Here\'s why:', 'madxartwork')), /*#__PURE__*/_react.default.createElement("ul", {
    className: "e-onboarding__feature-list"
  }, /*#__PURE__*/_react.default.createElement("li", null, __('Light-weight and fast loading', 'madxartwork')), /*#__PURE__*/_react.default.createElement("li", null, __('Great for SEO', 'madxartwork')), /*#__PURE__*/_react.default.createElement("li", null, __('Already being used by 1M+ web creators', 'madxartwork')))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__footnote"
...
var _context = __webpack_require__(/*! ../context/context */ "../app/modules/onboarding/assets/js/context/context.js");
var _router = __webpack_require__(/*! @reach/router */ "../node_modules/@reach/router/es/index.js");
var _useAjax3 = _interopRequireDefault(__webpack_require__(/*! madxartwork-app/hooks/use-ajax */ "../app/assets/js/hooks/use-ajax.js"));
...
function SiteLogo() {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("span", null, __('Otherwise, you can skip this and add one later.', 'madxartwork')), file && !showUnfilteredFilesDialog ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    src: file.url,
    alt: __('Potential Site Logo', 'madxartwork')
...
function SiteName() {
    ...
    actionButton = {
      ...
      onClick: function onClick() {
        ...
        if (nameInputRef.current.value !== state.siteName && '' !== nameInputRef.current.value) {
          setAjax({
            data: {
              action: 'madxartwork_update_site_name',
              data: JSON.stringify({
    ...
    if ('initial' !== ajaxState.status) {
      ...
      if ('success' === ajaxState.status && (_ajaxState$response = ajaxState.response) !== null && _ajaxState$response !== void 0 && _ajaxState$response.siteNameUpdated) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Sorry, the name wasn\'t saved. Try again, or skip for now.', 'madxartwork')
        });
      }
    }
  }, [ajaxState.status]);
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    image: madxartworkCommon.config.urls.assets + 'images/app/onboarding/Illustration_Setup.svg',
    title: __('Now, let\'s give your site a name.', 'madxartwork'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("p", null, __('This is what your site is called on the WP dashboard, and can be changed later from the general settings - it\'s not your website\'s URL.', 'madxartwork')), /*#__PURE__*/_react.default.createElement("input", {
...
function UploadAndInstallPro() {
  (0, _usePageTitle.default)({
    title: __('Upload and Install madxartwork Pro', 'madxartwork')
  });
  var _useContext = (0, _react.useContext)(_context.OnboardingContext),
    state = _useContext.state,
    _useAjax = (0, _useAjax2.default)(),
  ...
  (0, _react.useEffect)(function () {
    if ('initial' !== installProZipAjaxState.status) {
      ...
      setIsLoading(false);
      if ('success' === installProZipAjaxState.status && (_installProZipAjaxSta = installProZipAjaxState.response) !== null && _installProZipAjaxSta !== void 0 && _installProZipAjaxSta.madxartworkProInstalled) {
        madxartworkCommon.events.dispatchEvent({
          event: 'pro uploaded',
          version: '',
          details: {
  ...
  if (isLoading) {
    return /*#__PURE__*/_react.default.createElement(_madxartworkLoading.default, {
      loadingText: __('Uploading', 'madxartwork')
    });
  }
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, __('Don\'t know where to get the file from?', 'madxartwork') + ' ', /*#__PURE__*/_react.default.createElement("a", {
    onClick: function onClick() {
      return onProUploadHelpLinkClick();
    },
    href: 'https://my.madxartwork.com/subscriptions/' + madxartworkAppConfig.onboarding.utms.downloadPro,
    target: "_blank"
