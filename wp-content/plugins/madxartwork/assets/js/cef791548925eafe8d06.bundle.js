...
"use strict";
(self["webpackChunkmadxartwork"] = self["webpackChunkmadxartwork"] || []).push([["modules_nested-elements_assets_js_editor_nested-element-types-base_js"],{
...
var NestedElementTypesBase = /*#__PURE__*/function (_madxartwork$modules$el) {
  (0, _inherits2.default)(NestedElementTypesBase, _madxartwork$modules$el);
...
}(madxartwork.modules.elements.types.Base);
...
function AddSectionArea(props) {
  var addAreaElementRef = (0, _react.useRef)(),
    containerHelper = madxartwork.helpers.container;
  ...
  (0, _react.useEffect)(function () {
    ...
    defaultDroppableOptions.items = '> .madxartwork-add-section-inner';
    defaultDroppableOptions.hasDraggingOnChildClass = 'madxartwork-dragging-on-child';
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-add-section",
    ...
    className: "madxartwork-add-section-inner"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "e-view madxartwork-add-new-section"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-add-section-area-button madxartwork-add-section-button",
    onClick: function onClick() {
      return props.setIsRenderPresets(true);
    },
    title: __('Add new container', 'madxartwork'),
    role: "button",
    tabIndex: "0"
  }, /*#__PURE__*/_react.default.createElement("i", {
    className: "eicon-plus"
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-add-section-drag-title"
  }, __('Drag widgets here.', 'madxartwork')))));
}
...
function SelectPreset(props) {
  var containerHelper = madxartwork.helpers.container,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-add-section-close"
  }, /*#__PURE__*/_react.default.createElement("i", {
    onClick: function onClick() {
    ...
    className: "madxartwork-screen-only"
  }, __('Close', 'madxartwork'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-view e-con-select-preset"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "e-con-select-preset__title"
  }, __('Select your Structure', 'madxartwork')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-con-select-preset__list"
  }, madxartwork.presetsFactory.getContainerPresets().map(function (preset) {
    return /*#__PURE__*/_react.default.createElement("div", {
      onClick: function onClick() {
      ...
      dangerouslySetInnerHTML: {
        __html: madxartwork.presetsFactory.generateContainerPreset(preset)
      },
      role: "button",
      tabIndex: "0"
    });
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function events() {
      ...
      events.click = function (e) {
        var closest = e.target.closest('.madxartwork-element');
        ...
        if (['container', 'widget'].includes(closest === null || closest === void 0 ? void 0 : closest.dataset.element_type)) {
          ...
          var container = madxartwork.getContainer(closest.dataset.id);
