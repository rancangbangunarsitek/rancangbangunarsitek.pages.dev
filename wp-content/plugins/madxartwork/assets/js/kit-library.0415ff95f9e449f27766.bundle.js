...
(self["webpackChunkmadxartwork"] = self["webpackChunkmadxartwork"] || []).push([["kit-library"],{
...
/***/ "../app/assets/js/molecules/madxartwork-loading.js":
/*!*******************************************************!*\
  !*** ../app/assets/js/molecules/madxartwork-loading.js ***!
  \*******************************************************/
...
exports["default"] = madxartworkLoading;
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
function madxartworkLoading(props) {
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loading"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader-wrapper"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader-boxes"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader-box"
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader-box"
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "madxartwork-loader-box"
    ...
    className: "madxartwork-loading-title"
  }, props.loadingText)));
}
...
function App() {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: madxartworkAppConfig['kit-library']
    ...
    path: "/overview/:id"
  })))), madxartworkCommon.config.ismadxartworkDebug && /*#__PURE__*/_react.default.createElement(_devtools.ReactQueryDevtools, {
    initialIsOpen: false
  })));
}
...
var _react = _interopRequireWildcard(__webpack_require__(/*! react */ "react"));
var _router = __webpack_require__(/*! @reach/router */ "../node_modules/@reach/router/es/index.js");
var _appUi = __webpack_require__(/*! @madxartwork/app-ui */ "@madxartwork/app-ui");
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function ApplyKitDialog(props) {
  ...
  , {
    title: __('Apply %s?', 'madxartwork').replace('%s', props.title),
    text: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, __('You can use everything in this kit, or Customize to only include some items.', 'madxartwork'), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("br", null), __('By applying the entire kit, you\'ll override any styles, settings or content already on your site.', 'madxartwork')),
    approveButtonText: __('Apply All', 'madxartwork'),
    approveButtonColor: "primary",
    approveButtonOnClick: function approveButtonOnClick() {
      return startImportProcess(true);
    },
    dismissButtonText: __('Customize', 'madxartwork'),
  ...
  useEffect(function () {
    jQuery(approveButtonRef.current).madxartworkConnect({
      ...
      error: function error() {
        return props.onError(__('Unable to connect', 'madxartwork'));
      },
...
function EnvatoPromotion(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    ...
    variant: "xl"
  }, __('Looking for more Kits?', 'madxartwork'), " ", ' ', /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    variant: "underlined",
    color: "link",
...
function ErrorScreen(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Grid, {
    ...
    src: "".concat(madxartworkAppConfig.assets_url, "images/no-search-results.svg")
...
function FavoritesActions(props) {
  ...
  return props.isFavorite ? /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    text: __('Remove from Favorites', 'madxartwork'),
    hideText: true,
    icon: "eicon-heart",
    ...
    text: __('Add to Favorites', 'madxartwork'),
    hideText: true,
    icon: "eicon-heart-o",
  ...
  return (0, _react.useMemo)(function () {
    ...
    if (type === _useKitCallToAction3.TYPE_PROMOTION && subscriptionPlan) {
      return {
        ...
        text: __('Go %s', 'madxartwork').replace('%s', subscriptionPlan.label),
        hideText: false,
        variant: 'contained',
        color: 'cta',
        size: 'sm',
...
function ItemHeader(props) {
  ...
  var _useDownloadLinkMutat = (0, _useDownloadLinkMutation.default)(props.model, {
      ...
      onError: function onError(errorResponse) {
        if (401 === errorResponse.code) {
          madxartworkCommon.config.library_connect.is_connected = false;
          madxartworkCommon.config.library_connect.current_access_level = 0;
          updateSettings({
        ...
        setError({
          ...
          message: __('Something went wrong.', 'madxartwork')
        });
      }
    }),
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, error && /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    approveButtonUrl: "http://go.madxartwork.com/app-kit-library-error/",
    approveButtonOnClick: function approveButtonOnClick() {
      return setError(false);
    },
    dismissButtonText: __('Got it', 'madxartwork'),
    dismissButtonOnClick: function dismissButtonOnClick() {
      return setError(false);
    },
    onClose: function onClose() {
    ...
    onSuccess: function onSuccess(data) {
      ...
      madxartworkCommon.config.library_connect.current_access_level = accessLevel;
      updateSettings({
...
var KitListItem = function KitListItem(props) {
  ...
  }, !madxartworkAppConfig.hasPro && (subscriptionPlan === null || subscriptionPlan === void 0 ? void 0 : subscriptionPlan.label) && /*#__PURE__*/_react.default.createElement(_badge.default, {
    variant: "sm",
...
function HeaderBackButton(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: __('Back to Library', 'madxartwork'),
    onClick: function onClick() {
...
function Header(props) {
  ...
  }, __('Kit Library', 'madxartwork'))), props.centerColumn || /*#__PURE__*/_react.default.createElement("span", null), props.endColumn || /*#__PURE__*/_react.default.createElement("div", {
    style: {
      flex: 1
    }
...
function SortSelect(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: 'asc' === props.value.direction ? __('Sort Descending', 'madxartwork') : __('Sort Ascending', 'madxartwork'),
    hideText: true,
...
var TaxonomiesFilterList = function TaxonomiesFilterList(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_collapse.default, {
    ...
    ,
    placeholder: (0, _i18n.sprintf)(__('Search %s...', 'madxartwork'), props.taxonomiesByType.label),
    value: search,
  ...
  }, 0 === taxonomies.length && /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('No Results Found', 'madxartwork')), taxonomies.map(function (taxonomy) {
...
function fetchContentTypes() {
  return Promise.resolve([{
    id: 'page',
    label: __('Pages', 'madxartwork'),
    doc_types: ['wp-page'],
    order: 0
  }, {
    id: 'site-parts',
    label: __('Site Parts', 'madxartwork'),
...
if (!madxartworkAppConfig.hasPro) {
  taxonomyType.push({
...
function Favorites(props) {
  ...
  , {
    title: __('No favorites here yet...', 'madxartwork'),
    description: __('Use the heart icon to save kits that inspire you. You\'ll be able to find them here.', 'madxartwork'),
    button: {
      text: __('Continue browsing.', 'madxartwork'),
...
var _appUi = __webpack_require__(/*! @madxartwork/app-ui */ "@madxartwork/app-ui");
var _router = __webpack_require__(/*! @reach/router */ "../node_modules/@reach/router/es/index.js");
var _popoverDialog = _interopRequireDefault(__webpack_require__(/*! madxartwork-app/ui/popover-dialog/popover-dialog */ "../app/assets/js/ui/popover-dialog/popover-dialog.js"));
var _appsEventTracking = __webpack_require__(/*! madxartwork-app/event-track/apps-event-tracking */ "../app/assets/js/event-track/apps-event-tracking.js");
...
function IndexHeader(props) {
  ...
  var buttons = (0, _react.useMemo)(function () {
    return [{
      ...
      id: 'refetch',
      text: __('Refetch', 'madxartwork-pro'),
      hideText: true,
      ...
      id: 'import',
      text: __('Import', 'madxartwork-pro'),
      hideText: true,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_header.default, {
  ...
  }, __('Import Kit', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_appUi.ModalProvider, {
    title: __('Welcome to the Library', 'madxartwork'),
    ...
    tag: "h3",
    variant: "h3"
  }, __('What\'s a Website Kit?', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('A Website Kit is full, ready-made design that you can apply to your site. It includes all the pages, parts, settings and content that you\'d expect in a fully functional website.', 'madxartwork'))), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-kit-library-header-info-modal-container"
  }, /*#__PURE__*/_react.default.createElement(_appUi.Heading, {
    tag: "h3",
    variant: "h3"
  }, __('What\'s going on in the Kit Library?', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, __('Search & filter for kits by category and tags, or browse through individual kits to see what\'s inside.', 'madxartwork'), /*#__PURE__*/_react.default.createElement("br", null), __('Once you\'ve picked a winner, apply it to your site!', 'madxartwork'))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_appUi.Heading, {
    tag: "h3",
    variant: "h3"
  }, __('Happy browsing!', 'madxartwork')), /*#__PURE__*/_react.default.createElement(_appUi.Text, null, /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    url: "https://go.madxartwork.com/app-kit-library-how-to-use-kits/",
    target: "_blank",
    rel: "noreferrer",
  ...
  }), ' ', __('about using templates', 'madxartwork')))));
}
...
function useMenuItems(path) {
  return (0, _react.useMemo)(function () {
    ...
    return [{
      label: __('All Website Kits', 'madxartwork'),
      icon: 'eicon-filter',
      isActive: !page,
      url: '/kit-library',
      trackEventData: {
      ...
      label: __('Favorites', 'madxartwork'),
      icon: 'eicon-heart-o',
...
function Index(props) {
  (0, _usePageTitle.default)({
    title: __('Kit Library', 'madxartwork')
  });
  ...
  // eslint-disable-next-line @wordpress/i18n-ellipsis
  , {
    placeholder: __('Search all Website Kits...', 'madxartwork'),
    ...
    options: [{
      label: __('Featured', 'madxartwork'),
      value: 'featuredIndex',
      defaultOrder: 'asc',
      orderDisabled: true
    }, {
      label: __('New', 'madxartwork'),
      value: 'createdAt',
      defaultOrder: 'desc'
    }, {
      label: __('Popular', 'madxartwork'),
      value: 'popularityIndex',
      defaultOrder: 'desc'
    }, {
      label: __('Trending', 'madxartwork'),
      value: 'trendIndex',
      defaultOrder: 'desc'
    }],
    ...
    description: __('Nothing to worry about, use 🔄 on the top right to try again. If the problem continues, head over to the Help Center.', 'madxartwork'),
    button: {
      text: __('Learn More', 'madxartwork'),
      url: 'http://go.madxartwork.com/app-kit-library-error/',
      target: '_blank'
    }
    ...
    defaultComponent: /*#__PURE__*/_react.default.createElement(_errorScreen.default, {
      title: __('No results matched your search.', 'madxartwork'),
      description: __('Try different keywords or ', 'madxartwork'),
      button: {
        text: __('Continue browsing.', 'madxartwork'),
...
function OverviewSidebar(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    title: __('WHAT\'S INSIDE', 'madxartwork'),
...
var _react = _interopRequireWildcard(__webpack_require__(/*! react */ "react"));
var _content = _interopRequireDefault(__webpack_require__(/*! madxartwork-app/layout/content */ "../app/assets/js/layout/content.js"));
var _madxartworkLoading = _interopRequireDefault(__webpack_require__(/*! madxartwork-app/molecules/madxartwork-loading */ "../app/assets/js/molecules/madxartwork-loading.js"));
...
function Overview(props) {
  ...
  (0, _usePageTitle.default)({
    title: kit ? "".concat(__('Kit Library', 'madxartwork'), " | ").concat(kit.title) // eslint-disable-next-line @wordpress/i18n-ellipsis
  ...
  if (isLoading) {
    return /*#__PURE__*/_react.default.createElement(_madxartworkLoading.default, null);
  }
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
...
function Preview(props) {
  ...
  (0, _usePageTitle.default)({
    title: data ? "".concat(__('Kit Library', 'madxartwork'), " | ").concat(data.title) // eslint-disable-next-line @wordpress/i18n-ellipsis
    : __('Loading...', 'madxartwork')
  });
  if (isError) {
    // Will be caught by the App error boundary.
...
var NewPageKitListItem = function NewPageKitListItem() {
  return /*#__PURE__*/_react.default.createElement(_appUi.Card, {
    ...
    variant: "h5",
    className: "eps-card__headline"
  }, __('Blank Canvas', 'madxartwork'))), /*#__PURE__*/_react.default.createElement(_appUi.CardBody, null, /*#__PURE__*/_react.default.createElement(_appUi.CardImage, {
    alt: __('Blank Canvas', 'madxartwork'),
    src: madxartworkCommon.config.urls.assets + 'images/app/onboarding/Blank_Preview.jpg' || 0
