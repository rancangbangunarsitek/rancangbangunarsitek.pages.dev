...
function AdminTopBar() {
  ...
  var finderTooltipText = __('Search or do anything in madxartwork', 'madxartwork') + " ".concat(controlSign, "+E");
  ...
  }, window.madxartworkAdminTopBarConfig.is_administrator ? /*#__PURE__*/_react.default.createElement(_barButton.default, {
    onClick: finderAction,
    dataInfo: finderTooltipText,
    icon: "eicon-search-bold"
  }, __('Finder', 'madxartwork')) : '', window.madxartworkCloudAdmin ? window.madxartworkCloudAdmin() : ''), /*#__PURE__*/_react.default.createElement(_connectionButton.default, null)));
}
...
function ConnectionButton() {
  ...
  var isUserConnected = madxartworkAdminTopBarConfig.is_user_connected;
  (0, _react.useEffect)(function () {
  ...
  var tooltipText = __('Connect your account to get access to madxartwork\'s Template Library & more.', 'madxartwork'),
    connectUrl = madxartworkAdminTopBarConfig.connect_url,
    buttonText = __('Connect Account', 'madxartwork'),
    targetUrl = '_self';
  if (isUserConnected) {
    tooltipText = '';
    connectUrl = 'https://go.madxartwork.com/wp-dash-admin-bar-account/';
    buttonText = __('My madxartwork', 'madxartwork');
    targetUrl = '_blank';
  }
...
var usePageTitle = function usePageTitle() {
  var _useState = (0, _react.useState)('madxartwork'),
...
var AppWrapper = madxartworkCommon.config.isDebug ? _react.default.StrictMode : _react.default.Fragment;
var adminTopBarElement = document.getElementById('e-admin-top-bar-root');
var madxartworkMenuItemIds = ['toplevel_page_madxartwork', 'menu-posts-madxartwork_library'];
var menuItemSelector = madxartworkMenuItemIds.map(function (itemId) {
  return "#".concat(itemId, " .wp-menu-open");
}).join(', ');
var ismadxartworkPage = !!document.querySelector(menuItemSelector);
if (ismadxartworkPage) {
