...
var softDeprecated = function softDeprecated(name, version, replacement) {
  if (madxartworkDevToolsConfig.isDebug) {
...
var deprecatedMessage = function deprecatedMessage(type, name, version, replacement) {
  ...
  madxartworkDevTools.consoleWarn(message);
};
var Deprecation = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Deprecation, [{
    ...
    value: function isSoftDeprecated(version) {
      var total = this.compareVersion(version, madxartworkDevToolsConfig.deprecation.current_version);
      return total <= madxartworkDevToolsConfig.deprecation.soft_version_count;
    }
    ...
    value: function isHardDeprecated(version) {
      var total = this.compareVersion(version, madxartworkDevToolsConfig.deprecation.current_version);
      return total < 0 || total >= madxartworkDevToolsConfig.deprecation.hard_version_count;
    }
  }]);
  return Deprecation;
}();
...
/* global madxartworkDevToolsConfig */
var Module = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Module, [{
    ...
    value: function notifyBackendDeprecations() {
      var _this = this;
      var notices = madxartworkDevToolsConfig.deprecation.soft_notices;
    ...
    value: function consoleWarn() {
      var _console;
      var style = "font-size: 12px; background-image: url(\"".concat(madxartworkDevToolsConfig.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
...
if (!window.madxartworkDevTools) {
  window.madxartworkDevTools = new _module.default(new _deprecation.default());
  window.madxartworkDevTools.notifyBackendDeprecations();
}
})();
