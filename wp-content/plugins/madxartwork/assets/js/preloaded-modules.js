...
(self["webpackChunkmadxartwork"] = self["webpackChunkmadxartwork"] || []).push([["preloaded-modules"],{
...
class baseTabs extends madxartworkModules.frontend.handlers.Base {
  ...
  activateTab(tabIndex) {
    ...
    $requestedContent[settings.showTabFn](animationDuration, () => madxartworkFrontend.elements.$window.trigger('madxartwork-pro/motion-fx/recalc'));
...
exports["default"] = void 0;
class TextEditor extends madxartworkModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
        paragraph: 'p:first'
  ...
  getDefaultSettings() {
    return {
      selectors: {
        ...
        playIcon: '.madxartwork-custom-embed-play'
      }
    };
  }
  getDefaultElements() {
...
var _lightbox = _interopRequireDefault(__webpack_require__(/*! madxartwork-frontend/utils/lightbox/lightbox */ "../assets/dev/js/frontend/utils/lightbox/lightbox.js"));
madxartworkFrontend.elements.$window.on('madxartwork/frontend/init', () => {
  madxartworkFrontend.elementsHandler.elementsHandlers = {
  ...
  madxartworkFrontend.on('components:init', () => {
    ...
    delete madxartworkFrontend.utils.lightbox;
    madxartworkFrontend.utils.lightbox = new _lightbox.default();
  });
});
...
var _eIcons = __webpack_require__(/*! @madxartwork/e-icons */ "../assets/dev/js/frontend/utils/icons/e-icons.js");
module.exports = madxartworkModules.ViewModule.extend({
  oldAspectRatio: null,
  oldAnimation: null,
  swiper: null,
  player: null,
  isFontIconSvgExperiment: madxartworkFrontend.config.experimentalFeatures.e_font_icon_svg,
  getDefaultSettings() {
    return {
      classes: {
        ...
        slideshow: {
          container: madxartworkFrontend.config.swiperClass,
  ...
  setHTMLContent(html) {
    if (window.madxartworkCommon) {
      madxartworkDevTools.deprecation.deprecated('madxartworkFrontend.utils.lightbox.setHTMLContent', '3.1.4');
    }
