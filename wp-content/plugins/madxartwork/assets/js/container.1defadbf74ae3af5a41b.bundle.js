...
"use strict";
(self["webpackChunkmadxartwork"] = self["webpackChunkmadxartwork"] || []).push([["container"],{
...
/**
 * TODO: Try to merge with `section/handles-position.js` and create a generic solution using `.madxartwork-element`.
 */
class HandlesPosition extends madxartworkModules.frontend.handlers.Base {
  ...
  isFirstContainer() {
    return this.$element[0] === document.querySelector('.madxartwork-edit-mode .e-con:first-child');
  }
  isOverflowHidden() {
...
class Shapes extends madxartworkModules.frontend.handlers.Base {
  getDefaultSettings() {
    const contentWidth = this.getElementSettings('content_width'),
      container = 'boxed' === contentWidth ? '> .e-con-inner > .madxartwork-shape-%s' : '> .madxartwork-shape-%s';
    return {
      selectors: {
        container
      },
