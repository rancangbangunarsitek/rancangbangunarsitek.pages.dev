...
var NewTemplateView = __webpack_require__(/*! madxartwork-admin/new-template/view */ "../assets/dev/js/admin/new-template/view.js");
module.exports = madxartworkModules.common.views.modal.Layout.extend({
  getModalOptions: function getModalOptions() {
    return {
      id: 'madxartwork-new-template-modal'
    };
  },
  getLogoOptions: function getLogoOptions() {
    return {
      title: __('New Template', 'madxartwork')
    };
  },
  initialize: function initialize() {
    madxartworkModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
    var lookupControlIdPrefix = 'madxartwork-new-template__form__';
    ...
    var dynamicControlsVisibilityListener = function dynamicControlsVisibilityListener() {
      madxartworkAdmin.templateControls.setDynamicControlsVisibility(lookupControlIdPrefix, madxartwork_new_template_form_controls);
    };
  ...
  initElements: function initElements() {
    var container = this.$el[0],
      root = '#madxartwork-new-template__form';
    this.elements = {
...
module.exports = Marionette.ItemView.extend({
  id: 'madxartwork-new-template-dialog-content',
  template: '#tmpl-madxartwork-new-template',
  ui: {},
  events: {},
...
var NewTemplateLayout = __webpack_require__(/*! madxartwork-admin/new-template/layout */ "../assets/dev/js/admin/new-template/layout.js");
var NewTemplateModule = madxartworkModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      selectors: {
        addButton: '.page-title-action:first, #madxartwork-template-library-add-new'
      }
    };
  },
  ...
  bindEvents: function bindEvents() {
    ...
    madxartworkCommon.elements.$window.on('hashchange', this.showModalByHash.bind(this));
  },
...
jQuery(function () {
  window.madxartworkNewTemplate = new NewTemplateModule();
});
})();
