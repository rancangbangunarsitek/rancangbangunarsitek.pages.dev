            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                madxartwork.notifications.showToast({
                  message: __('Default settings changed.', 'madxartwork'),
                  buttons: [{
                    name: 'undo',
                    text: __('Undo', 'madxartwork'),
              ...
              case 9:
                ...
                madxartwork.notifications.showToast({
                  message: __('An error occurred.', 'madxartwork')
                });
                throw _context.t0;
              case 13:
                _context.prev = 13;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                madxartwork.notifications.showToast({
                  message: __('Default settings has been reset.', 'madxartwork')
                });
                _context.next = 12;
                break;
              case 8:
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                madxartwork.notifications.showToast({
                  message: __('Previous settings restored.', 'madxartwork')
                });
                _context.next = 12;
                break;
              case 8:
...
function getConfirmCreationDialog(_ref) {
  ...
  if (!introductionManager) {
    var _madxartwork$config$use;
    exports.introductionManager = introductionManager = createIntroductionManager();
    introductionManager.introductionViewed = !!((_madxartwork$config$use = madxartwork.config.user.introduction) !== null && _madxartwork$config$use !== void 0 && _madxartwork$config$use[introductionKey]);
  }
...
function createIntroductionManager() {
  ...
  var introduction = new madxartworkModules.editor.utils.Introduction({
    ...
    dialogOptions: {
      id: dialogId,
      headerMessage: __('Sure you want to change default settings?', 'madxartwork'),
      // Translators: %1$s: Opening strong tag, %2$s: Closing strong tag.
      message: __('Your changes will automatically be saved for future uses of this element. %1$sNote:%2$s This includes sensitive information like emails, API keys, etc.', 'madxartwork').replace('%1$s', '<strong>').replace('%2$s', '</strong>'),
      effects: {
        show: 'fadeIn',
        hide: 'fadeOut'
      },
...
function createCheckboxAndLabel(dialogId) {
  ...
  label.textContent = __('Do not show this message again', 'madxartwork');
...
var Module = /*#__PURE__*/function (_madxartworkModules$edi) {
  (0, _inherits2.default)(Module, _madxartworkModules$edi);
  ...
  (0, _createClass2.default)(Module, [{
    ...
    key: "onmadxartworkInitComponents",
    value: function onmadxartworkInitComponents() {
...
function _addContextMenuItem2() {
  var _madxartwork$config, _madxartwork$config$use;
  if (!((_madxartwork$config = madxartwork.config) !== null && _madxartwork$config !== void 0 && (_madxartwork$config$use = _madxartwork$config.user) !== null && _madxartwork$config$use !== void 0 && _madxartwork$config$use.is_administrator)) {
    return;
  }
  ['widget', 'container', 'section'].forEach(function (elType) {
    madxartwork.hooks.addFilter("elements/".concat(elType, "/contextMenuGroups"), function (groups, view) {
      var _view$options;
      ...
      return groups.map(function (group) {
        ...
        group.actions = [].concat((0, _toConsumableArray2.default)(group.actions), [{
          ...
          title: __('Save as default', 'madxartwork'),
          callback: function callback() {
