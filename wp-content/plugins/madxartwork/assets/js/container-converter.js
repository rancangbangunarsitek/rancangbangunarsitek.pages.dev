...
var ConvertAll = /*#__PURE__*/function (_$e$modules$document$) {
  ...
  (0, _createClass2.default)(ConvertAll, [{
    ...
    value: function getHistory() {
      return {
        type: __('Converted to Containers', 'madxartwork'),
        title: __('All Content', 'madxartwork')
      };
    }
  }, {
    key: "apply",
    value: function apply() {
      var _madxartwork$getPreview = madxartwork.getPreviewContainer(),
        children = _madxartwork$getPreview.children;
...
var Convert = /*#__PURE__*/function (_$e$modules$document$) {
  ...
  (0, _createClass2.default)(Convert, [{
    ...
    value: function getHistory() {
      return {
        type: __('Converted to Container', 'madxartwork'),
        title: __('Section', 'madxartwork')
      };
    }
  }, {
    key: "validateArgs",
...
var _default = /*#__PURE__*/function (_$e$modules$Component) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function bindEvents() {
      madxartwork.channels.editor.on('madxartworkContainerConverter:convert', function (_ref) {
        var container = _ref.container,
          el = _ref.el;
        var button = el.querySelector('.madxartwork-button');
        ...
        setTimeout(function () {
          ...
          madxartwork.notifications.showToast({
            message: __('Your changes have been updated.', 'madxartwork')
          });
        });
      });
    }
...
function responsive(key, value) {
  var breakpoints = [''].concat((0, _toConsumableArray2.default)(Object.keys(madxartworkFrontend.config.responsive.activeBreakpoints)));
