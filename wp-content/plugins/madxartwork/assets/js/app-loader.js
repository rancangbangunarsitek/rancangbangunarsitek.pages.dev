  ...
  (0, _createClass2.default)(Load, [{
    ...
    value: function apply(args) {
      ...
      if (!component.iframe) {
        ...
        component.iframe.className = 'madxartwork-app-iframe';
...
var Component = /*#__PURE__*/function (_ComponentModalBase) {
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function defaultRoutes() {
      ...
      return {
        '': function _(args) {
          args.url = args.url || madxartworkAppConfig.menu_url;
          $e.run('app/load', args);
...
var AppLoader = /*#__PURE__*/function () {
  function AppLoader() {
    ...
    (0, _defineProperty2.default)(this, "selector", 'a.madxartwork-app-link, .madxartwork-app-link .ab-item');
