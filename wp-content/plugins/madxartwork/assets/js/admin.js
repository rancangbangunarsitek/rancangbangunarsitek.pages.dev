...
module.exports = madxartworkModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      selectors: {
        modeSelect: '.madxartwork_maintenance_mode_mode select',
        maintenanceModeTable: '#tab-maintenance_mode table',
        maintenanceModeDescriptions: '.madxartwork-maintenance-mode-description',
        excludeModeSelect: '.madxartwork_maintenance_mode_exclude_mode select',
        excludeRolesArea: '.madxartwork_maintenance_mode_exclude_roles',
        templateSelect: '.madxartwork_maintenance_mode_template_id select',
        editTemplateButton: '.madxartwork-edit-template',
        maintenanceModeError: '.madxartwork-maintenance-mode-error'
      },
      classes: {
        isEnabled: 'madxartwork-maintenance-mode-is-enabled'
      }
    };
  },
  ...
  handleTemplateSelectChange: function handleTemplateSelectChange() {
    ...
    var editUrl = madxartworkAdmin.config.home_url + '?p=' + templateID + '&madxartwork';
  ...
  onInit: function onInit() {
    ...
    madxartworkCommon.elements.$window.on('madxartwork/admin/init', this.onAdminInit);
  }
});
...
var MenuHandler = /*#__PURE__*/function (_madxartworkModules$Vie) {
  (0, _inherits2.default)(MenuHandler, _madxartworkModules$Vie);
...
var TemplateControls = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(TemplateControls, [{
    ...
    value: function changeVisibilityBasedOnCondition(lookupControlIdPrefix, condition, controlId) {
      ...
      targetControlWrapper.classList.toggle('madxartwork-hidden', !lookupControl || conditionValue !== lookupControl.value);
    }
  }]);
...
var ExperimentsDependency = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ExperimentsDependency, [{
    ...
    value: function getExperimentData(experimentId) {
      return madxartworkAdminConfig.experiments[experimentId];
    }
  }, {
    ...
    value: function deactivateDependantExperiments(experimentId) {
      var _this4 = this;
      Object.entries(madxartworkAdminConfig.experiments).forEach(function (_ref2) {
    ...
    value: function showDependenciesDialog(experimentId) {
      ...
      var message = __('In order to use %1$s, first you need to activate %2$s.', 'madxartwork').replace('%1$s', "<strong>".concat(experiment.title, "</strong>")).replace('%2$s', "<strong>".concat(dependenciesList, "</strong>"));
      madxartworkCommon.dialogsManager.createWidget('confirm', {
        id: 'e-experiments-dependency-dialog',
        headerMessage: __('First, activate another experiment.', 'madxartwork'),
        message: message,
        position: {
          my: 'center center',
          at: 'center center'
        ...
        strings: {
          confirm: __('Activate', 'madxartwork'),
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var ExperimentsModule = /*#__PURE__*/function (_madxartworkModules$Vie) {
  (0, _inherits2.default)(ExperimentsModule, _madxartworkModules$Vie);
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          ...
          experimentForm: '#madxartwork-settings-form',
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "../node_modules/@babel/runtime/helpers/getPrototypeOf.js"));
var _menuHandler = _interopRequireDefault(__webpack_require__(/*! madxartwork-admin/menu-handler */ "../assets/dev/js/admin/menu-handler.js"));
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = (0, _getPrototypeOf2.default)(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = (0, _getPrototypeOf2.default)(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return (0, _possibleConstructorReturn2.default)(this, result); }; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
  ...
  (0, _createClass2.default)(LandingPagesHandler, [{
    ...
    value: function getDefaultSettings() {
      var pageName = 'e-landing-page',
        adminMenuSelectors = {
          ...
          landingPagesAddNewPage: 'a[href="edit.php?post_type=madxartwork_library&page=' + pageName + '"]'
        };
      return {
        selectors: {
          ...
          templatesMenuItem: '.menu-icon-madxartwork_library'
        }
      };
    }
  }, {
    ...
    value: function onInit() {
      ...
      if (isLandingPagesTablePage || isLandingPagesTrashPage || isLandingPagesCreateYourFirstPage || settings.isLandingPageAdminEdit) {
        ...
        // Overwrite the 'Add New' button at the top of the page to open in madxartwork with the library module open.
        jQuery(settings.selectors.addButton).attr('href', madxartworkAdminConfig.urls.addNewLandingPageUrl);
      }
    }
  }]);
...
var _default = /*#__PURE__*/function (_madxartworkModules$Mod) {
  ...
  function _default() {
    ...
    madxartworkCommon.elements.$window.on('madxartwork/admin/init', function () {
      _this.runHandler();
    });
    return _this;
  }
  (0, _createClass2.default)(_default, [{
    ...
    value: function runHandler() {
      var _madxartworkAdmin$confi, _madxartworkAdmin$confi2;
      var pageName = 'e-landing-page',
        paths = {
          landingPagesTablePage: 'edit.php?post_type=' + pageName,
          landingPagesAddNewPage: 'edit.php?post_type=madxartwork_library&page=' + pageName,
          landingPagesTrashPage: 'edit.php?post_status=trash&post_type=' + pageName
        },
        args = {
          path: (_madxartworkAdmin$confi = madxartworkAdmin.config.landingPages) !== null && _madxartworkAdmin$confi !== void 0 && _madxartworkAdmin$confi.landingPagesHasPages ? paths.landingPagesTablePage : paths.landingPagesAddNewPage,
          isLandingPageAdminEdit: (_madxartworkAdmin$confi2 = madxartworkAdmin.config.landingPages) === null || _madxartworkAdmin$confi2 === void 0 ? void 0 : _madxartworkAdmin$confi2.isLandingPageAdminEdit,
          paths: paths
        };
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "../node_modules/@babel/runtime/helpers/interopRequireDefault.js");
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "../node_modules/@babel/runtime/helpers/slicedToArray.js"));
var _module = _interopRequireDefault(__webpack_require__(/*! madxartwork/modules/landing-pages/assets/js/admin/module */ "../modules/landing-pages/assets/js/admin/module.js"));
var _module2 = _interopRequireDefault(__webpack_require__(/*! madxartwork/core/experiments/assets/js/admin/module */ "../core/experiments/assets/js/admin/module.js"));
...
(function ($) {
  var madxartworkAdmin = madxartworkModules.ViewModule.extend({
    maintenanceMode: null,
    config: madxartworkAdminConfig,
    getDefaultElements: function getDefaultElements() {
      var elements = {
        $switchMode: $('#madxartwork-switch-mode'),
        $goToEditLink: $('#madxartwork-go-to-edit-page-link'),
        $switchModeInput: $('#madxartwork-switch-mode-input'),
        $switchModeButton: $('#madxartwork-switch-mode-button'),
        $madxartworkLoader: $('.madxartwork-loader'),
        $builderEditor: $('#madxartwork-editor'),
        $importButton: $('#madxartwork-import-template-trigger'),
        $importNowButton: $('#e-import-template-action'),
        $importArea: $('#madxartwork-import-template-area'),
        $importForm: $('#madxartwork-import-template-form'),
        $importFormFileInput: $('#madxartwork-import-template-form input[type="file"]'),
        $settingsForm: $('#madxartwork-settings-form'),
        $settingsTabsWrapper: $('#madxartwork-settings-tabs-wrapper'),
        $menuGetHelpLink: $('a[href="admin.php?page=go_knowledge_base_site"]'),
        $menuGoProLink: $('a[href="admin.php?page=go_madxartwork_pro"]'),
        $reMigrateGlobalsButton: $('.madxartwork-re-migrate-globals-button')
      };
      elements.$settingsFormPages = elements.$settingsForm.find('.madxartwork-settings-form-page');
      elements.$activeSettingsPage = elements.$settingsFormPages.filter('.madxartwork-active');
    ...
    toggleStatus: function toggleStatus() {
      var ismadxartworkMode = this.ismadxartworkMode();
      madxartworkCommon.elements.$body.toggleClass('madxartwork-editor-active', ismadxartworkMode).toggleClass('madxartwork-editor-inactive', !ismadxartworkMode);
    },
    bindEvents: function bindEvents() {
      var self = this;
      self.elements.$switchModeButton.on('click', function (event) {
        ...
        if (self.ismadxartworkMode()) {
          ...
          var $wpTitle = $('#title');
          if (!$wpTitle.val()) {
            $wpTitle.val('madxartwork #' + $('#post_ID').val());
          }
          if (wp.autosave) {
          ...
          $(document).on('heartbeat-tick.autosave', function () {
            madxartworkCommon.elements.$window.off('beforeunload.edit-post');
      ...
      $('#madxartwork-clear-cache-button').on('click', function (event) {
        event.preventDefault();
        var $thisButton = $(this);
        $thisButton.removeClass('success').addClass('loading');
        $.post(ajaxurl, {
          action: 'madxartwork_clear_cache',
          _nonce: $thisButton.data('nonce')
        }).done(function () {
          $thisButton.removeClass('loading').addClass('success');
        });
      });
      $('#madxartwork-library-sync-button').on('click', function (event) {
        event.preventDefault();
        var $thisButton = $(this);
        $thisButton.removeClass('success').addClass('loading');
        $.post(ajaxurl, {
          action: 'madxartwork_reset_library',
          _nonce: $thisButton.data('nonce')
        }).done(function () {
          $thisButton.removeClass('loading').addClass('success');
        });
      });
      $('#madxartwork-recreate-kit-button').on('click', function (event) {
        event.preventDefault();
        var $thisButton = $(this);
        $thisButton.removeClass('success error').addClass('loading').next('.e-recreate-kit-error-message').remove();
        $.post(ajaxurl, {
          action: 'madxartwork_recreate_kit',
          _nonce: $thisButton.data('nonce')
        }).done(function () {
          $thisButton.removeClass('loading').addClass('success');
        }).fail(function (_ref) {
      ...
      $('#madxartwork-replace-url-button').on('click', function (event) {
        event.preventDefault();
        var $this = $(this),
          $tr = $this.parents('tr'),
        ...
        $.post(ajaxurl, {
          action: 'madxartwork_replace_url',
          from: $from.val(),
          to: $to.val(),
          ...
          madxartworkCommon.dialogsManager.createWidget('alert', {
            message: response.data
          }).show();
        });
      });
      $('#madxartwork_upgrade_fa_button').on('click', function (event) {
        event.preventDefault();
        var $updateButton = $(this);
        $updateButton.addClass('loading');
        madxartworkCommon.dialogsManager.createWidget('confirm', {
          id: 'confirm_fa_migration_admin_modal',
          message: __('I understand that by upgrading to Font Awesome 5,', 'madxartwork') + '<br>' + __('I acknowledge that some changes may affect my website and that this action cannot be undone.', 'madxartwork'),
          headerMessage: __('Font Awesome 5 Migration', 'madxartwork'),
          strings: {
            confirm: __('Continue', 'madxartwork'),
            cancel: __('Cancel', 'madxartwork')
          },
          ...
          onConfirm: function onConfirm() {
            ...
            $.post(ajaxurl, {
              ...
              $('#madxartwork_upgrade_fa_button').parent().append(messageElement);
              if (redirectUrl) {
      ...
      $('select.madxartwork-rollback-select').on('change', function () {
        var $this = $(this),
          $rollbackButton = $this.next('.madxartwork-rollback-button'),
      ...
      $('.madxartwork-rollback-button').on('click', function (event) {
        event.preventDefault();
        var $this = $(this);
        madxartworkCommon.dialogsManager.createWidget('confirm', {
          headerMessage: __('Rollback to Previous Version', 'madxartwork'),
          message: __('Are you sure you want to reinstall previous version?', 'madxartwork'),
          strings: {
            confirm: __('Continue', 'madxartwork'),
            cancel: __('Cancel', 'madxartwork')
          },
      ...
      self.elements.$reMigrateGlobalsButton.on('click', function (event) {
        ...
        madxartworkCommon.dialogsManager.createWidget('confirm', {
          headerMessage: __('Migrate to v3.0', 'madxartwork'),
          message: __('Please note that this process will revert all changes made to Global Colors and Fonts since upgrading to v3.x.', 'madxartwork'),
          strings: {
            confirm: __('Continue', 'madxartwork'),
            cancel: __('Cancel', 'madxartwork')
          },
          onConfirm: function onConfirm() {
            $this.removeClass('success').addClass('loading');
            madxartworkCommon.ajax.addRequest('re_migrate_globals', {
              success: function success() {
      ...
      $('.madxartwork_css_print_method select').on('change', function () {
        var $descriptions = $('.madxartwork-css-print-method-description');
        $descriptions.hide();
        $descriptions.filter('[data-value="' + $(this).val() + '"]').show();
      }).trigger('change');
      $('.madxartwork_google_font select').on('change', function () {
        $('.madxartwork_font_display').toggle('1' === $(this).val());
      }).trigger('change');
    },
    onInit: function onInit() {
      madxartworkModules.ViewModule.prototype.onInit.apply(this, arguments);
      ...
      if (madxartworkCommon.config.experimentalFeatures['landing-pages']) {
        new _module.default();
      }
    ...
    initTemplatesImport: function initTemplatesImport() {
      if (!madxartworkCommon.elements.$body.hasClass('post-type-madxartwork_library')) {
        return;
      }
      var self = this,
      ...
      $importButton.on('click', function () {
        $('#madxartwork-import-template-area').toggle();
      });
      $importForm.on('submit', function (event) {
        $importNowButton[0].disabled = true;
        $importNowButton[0].value = __('Importing...', 'madxartwork');
        if ($importFormFileInput[0].files.length && !madxartworkCommon.config.filesUpload.unfilteredFiles) {
          event.preventDefault();
    ...
    initMaintenanceMode: function initMaintenanceMode() {
      var MaintenanceMode = __webpack_require__(/*! madxartwork-admin/maintenance-mode */ "../assets/dev/js/admin/maintenance-mode.js");
      this.maintenanceMode = new MaintenanceMode();
    },
    ismadxartworkMode: function ismadxartworkMode() {
      return !!this.elements.$switchModeInput.val();
    },
    animateLoader: function animateLoader() {
      this.elements.$goToEditLink.addClass('madxartwork-animate');
    },
    ...
    goToSettingsTab: function goToSettingsTab(tabName) {
      ...
      this.elements.$activeSettingsPage.removeClass('madxartwork-active');
      this.elements.$activeSettingsTab.removeClass('nav-tab-active');
      var $activeTab = this.elements.$settingsTabs.filter('#madxartwork-settings-' + tabName);
      $activePage.addClass('madxartwork-active');
    ...
    roleManager: {
      selectors: {
        body: 'madxartwork-role-manager',
        row: '.madxartwork-role-row',
        label: '.madxartwork-role-label',
        excludedIndicator: '.madxartwork-role-excluded-indicator',
        excludedField: 'input[name="madxartwork_exclude_user_roles[]"]',
        controlsContainer: '.madxartwork-role-controls',
        toggleHandle: '.madxartwork-role-toggle',
  ...
  $(function () {
    window.madxartworkAdmin = new madxartworkAdmin();
    _events.default.dispatch(madxartworkCommon.elements.$window, 'madxartwork/admin/init');
  });
})(jQuery);
})();
