...
export default function ImportComplete() {
	const sharedContext = useContext( SharedContext ),
		...
		{ madxartworkHomePageUrl, recentlyEditedmadxartworkPageUrl } = importedData?.configData || {},
			...
			<WizardStep
				...
				notice={ (
					<>
						...
						</InlineLink> { __( 'to learn more about building your site with madxartwork Kits', 'madxartwork' ) }
					</>
				) }
			>
