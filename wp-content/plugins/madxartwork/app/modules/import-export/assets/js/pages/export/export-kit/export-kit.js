...
export default function ExportKit() {
	...
	sharedContext = useContext( SharedContext ),
		...
		getLearnMoreLink = () => (
			<InlineLink url="https://go.madxartwork.com/app-what-are-kits" italic>
	...
	useEffect( () => {
		...
		sharedContext.dispatch( { type: 'SET_CPT', payload: cptObjectToOptionsArray( madxartworkAppConfig[ 'import-export' ].summaryTitles.content?.customPostTypes, 'plural' ) } );
	}, [] );
		...
		<Layout type="export" footer={ getFooter() }>
			<section className="e-app-export-kit">
				<PageHeader
					...
					description={ [
						__( 'Choose which madxartwork components - templates, content and site settings - to include in your kit file.', 'madxartwork' ),
