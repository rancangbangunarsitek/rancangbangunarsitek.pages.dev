...
import Box from 'madxartwork-app/ui/atoms/box';
import List from 'madxartwork-app/ui/molecules/list';
...
export default function ImportResolver() {
	const sharedContext = useContext( SharedContext ),
		...
		getLearnMoreLink = () => (
			<InlineLink url="https://go.madxartwork.com/app-what-are-kits" italic onClick={ () => eventTracking( 'kit-library/seek-more-info' ) }>
	...
	return (
		<Layout type="import" footer={ getFooter() }>
			<section className="e-app-import-resolver">
				...
				{
					isHomePageOverride() &&
					<Notice className="e-app-import-resolver__notice" label={ __( 'Note:', 'madxartwork' ) } color="warning">
						{ __( "Your site's homepage will be determined by the kit. You can change this later.", 'madxartwork' ) }
					</Notice>
				}

				<Panel isOpened={ true }>
					<Panel.Header toggle={ false }>
						<Panel.Headline>{ __( 'Select the items you want to keep and apply:', 'madxartwork' ) }</Panel.Headline>
					</Panel.Header>
