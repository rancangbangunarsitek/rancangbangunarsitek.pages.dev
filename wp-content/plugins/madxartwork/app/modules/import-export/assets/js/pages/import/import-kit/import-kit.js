...
export default function ImportKit() {
	const sharedContext = useContext( SharedContext ),
		...
		getLearnMoreLink = () => (
			<InlineLink url="https://go.madxartwork.com/app-what-are-kits" key="learn-more-link" italic onClick={ () => eventTracking( 'kit-library/seek-more-info', null, 'click' ) } >
		...
		<Layout type="import">
			<section className="e-app-import">
				...
				<PageHeader
					...
					description={ [
						__( 'Upload a file with templates, site settings, content, etc., and apply them to your site automatically.', 'madxartwork' ),
						getLearnMoreLink(),
					] }
				/>

				<Notice label={ __( 'Important:', 'madxartwork' ) } color="warning" className="e-app-import__notice">
					{ __( 'We recommend that you backup your site before importing a kit file.', 'madxartwork' ) }
				</Notice>
