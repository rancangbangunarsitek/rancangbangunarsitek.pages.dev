		...
		/> } >
			<section className="e-app-import-plugins">
...

				{
					...
					<Notice label={ __( ' Recommended:', 'madxartwork' ) } className="e-app-import-plugins__versions-notice" color="warning">
						{ __( 'Head over to Updates and make sure that your plugins are updated to the latest version.', 'madxartwork' ) } <InlineLink url={ madxartworkAppConfig.admin_url + 'update-core.php' }>{ __( 'Take me there', 'madxartwork' ) }</InlineLink>
					</Notice>
				}
