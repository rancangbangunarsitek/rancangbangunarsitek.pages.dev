...
import { Text, Button, Grid } from '@madxartwork/app-ui';
			...
			<Text className="e-kit-library__filter-indication-text">
				{
					...
					sprintf( _n( 'Showing %s result for', 'Showing %s results for', props.resultCount, 'madxartwork' ), ! props.resultCount ? __( 'no', 'madxartwork' ) : props.resultCount ) }
				{ ' ' }
