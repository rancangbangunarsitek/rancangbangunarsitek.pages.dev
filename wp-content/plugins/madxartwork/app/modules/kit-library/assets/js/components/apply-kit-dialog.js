...
export default function ApplyKitDialog( props ) {
	...
	return (
		<Dialog
			...
			text={ <>
				{ __( 'You can use everything in this kit, or Customize to only include some items.', 'madxartwork' ) }
				<br /><br />
				{ __( 'By applying the entire kit, you\'ll override any styles, settings or content already on your site.', 'madxartwork' ) }
			</> }
