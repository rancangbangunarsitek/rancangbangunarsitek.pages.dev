	...
	return (
		...
		>
			<div className="e-onboarding__go-pro-content">
				<h2 className="e-onboarding__go-pro-title">{ __( 'Ready to Get madxartwork Pro?', 'madxartwork' ) }</h2>
				<Checklist>
					<ChecklistItem>{ __( '90+ Basic & Pro widgets', 'madxartwork' ) }</ChecklistItem>
					<ChecklistItem>{ __( '300+ Basic & Pro templates', 'madxartwork' ) }</ChecklistItem>
					<ChecklistItem>{ __( 'Premium Support', 'madxartwork' ) }</ChecklistItem>
				</Checklist>
				<div className="e-onboarding__go-pro-paragraph">
					{ __( 'And so much more!', 'madxartwork' ) }
				</div>
				<div className="e-onboarding__go-pro-paragraph">
					<Button buttonSettings={ getElProButton } />
				</div>
				<div className="e-onboarding__go-pro-paragraph">
					<a tabIndex="0" className="e-onboarding__go-pro-already-have" ref={ alreadyHaveProButtonRef } href={ madxartworkAppConfig.onboarding.urls.uploadPro } rel="opener">
